...
from aas_core_meta.verification import is_IRI, is_IRDI, is_ID_short, are_unique
...
class Asset_information:
    ...
    already exist, the corresponding attribute :py:attr:`~global_asset_ID` is optional.
    """
