  ...
  if (literal === null) {
    return newDeserializationError<AasTypes.ModelingKind>(
      "Not a valid string representation of " +
        `a literal of ModelingKind: ${jsonable}`
    );
  }

  return new AasCommon.Either<
    AasTypes.ModelingKind,
    DeserializationError
  >(literal, null);
}
...
class SetterForAssetAdministrationShell {
  ...
  setDisplayNameFromJsonable(
    ...
    const items =
      new Array<AasTypes.LangString>();

    let i = 0;
    for (const jsonableItem of iterable) {
      const itemOrError = langStringFromJsonable(
        jsonableItem
      );
...
class SetterForSubmodel {
  ...
  setKindFromJsonable(
    ...
    const parsedOrError = modelingKindFromJsonable(
      jsonable
    );
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
...
class SetterForEntity {
   ...
   * @returns error, if any
   */
  setSpecificAssetIdFromJsonable(
    jsonable: JsonValue
  ): DeserializationError | null {
    const parsedOrError = specificAssetIdFromJsonable(
      jsonable
    );
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
...
> {
  ...
  for (const key in jsonable) {
    const jsonableValue = jsonable[key];
    const setterMethod =
      SETTER_MAP_FOR_LANG_STRING.get(key);
...
export function levelTypeFromJsonable(
  ...
  if (literal === null) {
    return newDeserializationError<AasTypes.LevelType>(
      "Not a valid string representation of " +
        `a literal of LevelType: ${jsonable}`
    );
  }
...
class SetterForDataSpecificationPhysicalUnit {
   ...
   * @returns error, if any
   */
  setConversionFactorFromJsonable(
    jsonable: JsonValue
  ): DeserializationError | null {
    const parsedOrError = stringFromJsonable(
      jsonable
...
> {
  ...
  for (const key in jsonable) {
    const jsonableValue = jsonable[key];
    const setterMethod =
      SETTER_MAP_FOR_DATA_SPECIFICATION_PHYSICAL_UNIT.get(key);
...
const SETTER_MAP_FOR_ASSET_ADMINISTRATION_SHELL =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForAssetAdministrationShell.prototype.setChecksumFromJsonable
      ],
      [
        "administration",
...
const SETTER_MAP_FOR_SUBMODEL =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForSubmodel.prototype.setChecksumFromJsonable
      ],
      [
        "administration",
...
const SETTER_MAP_FOR_RELATIONSHIP_ELEMENT =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForRelationshipElement.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForRelationshipElement.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_SUBMODEL_ELEMENT_LIST =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForSubmodelElementList.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForSubmodelElementList.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_SUBMODEL_ELEMENT_COLLECTION =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForSubmodelElementCollection.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForSubmodelElementCollection.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_PROPERTY =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForProperty.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForProperty.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_MULTI_LANGUAGE_PROPERTY =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForMultiLanguageProperty.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForMultiLanguageProperty.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_RANGE =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForRange.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForRange.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_REFERENCE_ELEMENT =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForReferenceElement.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForReferenceElement.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_BLOB =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForBlob.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForBlob.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_FILE =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForFile.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForFile.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_ANNOTATED_RELATIONSHIP_ELEMENT =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForAnnotatedRelationshipElement.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForAnnotatedRelationshipElement.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_ENTITY =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForEntity.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForEntity.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
      ...
      [
        "specificAssetId",
        SetterForEntity.prototype.setSpecificAssetIdFromJsonable
      ],
      [
        "modelType",
...
const SETTER_MAP_FOR_BASIC_EVENT_ELEMENT =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForBasicEventElement.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForBasicEventElement.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_OPERATION =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForOperation.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForOperation.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_CAPABILITY =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForCapability.prototype.setChecksumFromJsonable
      ],
      [
        "kind",
        SetterForCapability.prototype.setKindFromJsonable
      ],
      [
        "semanticId",
...
const SETTER_MAP_FOR_CONCEPT_DESCRIPTION =
  ...
  >(
    [
      ...
      [
        "checksum",
        SetterForConceptDescription.prototype.setChecksumFromJsonable
      ],
      [
        "administration",
...
const SETTER_MAP_FOR_LANG_STRING =
  new Map<
    string,
    (
      jsonable: JsonValue
  ...
  >(
    [
      [
        "language",
        SetterForLangString.prototype.setLanguageFromJsonable
      ],
      [
        "text",
        SetterForLangString.prototype.setTextFromJsonable
      ],
      [
        "modelType",
        SetterForLangString.prototype.ignore
      ]
    ]
  );
  ...
  >(
    [
      ...
      [
        ...
        dataSpecificationPhysicalUnitFromJsonable
      ]
    ]
  );
...
const SETTER_MAP_FOR_DATA_SPECIFICATION_PHYSICAL_UNIT =
  new Map<
    string,
    (
      jsonable: JsonValue
  ...
  >(
    [
      ...
      [
        "siName",
        SetterForDataSpecificationPhysicalUnit.prototype.setSiNameFromJsonable
      ],
      [
        "dinNotation",
      ...
      [
        "eceName",
        SetterForDataSpecificationPhysicalUnit.prototype.setEceNameFromJsonable
      ],
      [
        "eceCode",
        SetterForDataSpecificationPhysicalUnit.prototype.setEceCodeFromJsonable
      ],
      [
        "nistName",
      ...
      [
        ...
        SetterForDataSpecificationPhysicalUnit.prototype.setRegistrationAuthorityIdFromJsonable
      ],
      [
        "supplier",
      ...
      [
        "modelType",
        SetterForDataSpecificationPhysicalUnit.prototype.ignore
      ]
    ]
  );
...
class Serializer extends AasTypes.AbstractTransformer<JsonObject> {
  ...
  transformAssetInformation(
    ...
    if (that.globalAssetId !== null) {
      jsonable["globalAssetId"] =
        this.transform(that.globalAssetId);
    }
  ...
  transformSubmodel(
    ...
    if (that.kind !== null) {
      jsonable["kind"] =
        AasStringification.mustModelingKindToString(
          that.kind
        );
    }
  ...
  transformEntity(
    ...
    if (that.specificAssetId !== null) {
      jsonable["specificAssetId"] =
        this.transform(that.specificAssetId);
    }
  ...
  transformDataSpecificationIec61360(
    ...
    if (that.levelType !== null) {
      jsonable["levelType"] =
        AasStringification.mustLevelTypeToString(
          that.levelType
        );
    }
  ...
  transformDataSpecificationPhysicalUnit(
    ...
    if (that.conversionFactor !== null) {
      jsonable["conversionFactor"] =
        that.conversionFactor;
    }

    if (that.registrationAuthorityId !== null) {
      jsonable["registrationAuthorityId"] =
