 ...
 */
export function modelingKindFromString(
  text: string
): AasTypes.ModelingKind | null {
 ...
 */
export function modelingKindToString(
  value: AasTypes.ModelingKind
): string | null {
 ...
 */
export function mustModelingKindToString(
  value: AasTypes.ModelingKind
): string {
  const result = MODELING_KIND_TO_STRING.get(value);
  if (result === undefined) {
    throw new Error(
      `Invalid literal of ModelingKind: ${value}`
    );
  }
  return result;
}
 ...
 */
export function levelTypeFromString(
  text: string
): AasTypes.LevelType | null {
 ...
 */
export function levelTypeToString(
  value: AasTypes.LevelType
): string | null {
 ...
 * if the `value` is invalid
 */
export function mustLevelTypeToString(
  value: AasTypes.LevelType
): string {
  const result = LEVEL_TYPE_TO_STRING.get(value);
  if (result === undefined) {
    throw new Error(
      `Invalid literal of LevelType: ${value}`
    );
  }
  return result;
}
