...
Here is an example how to verify an instance of :py:class:`test.types.ListOfPrimitives`:

.. code-block::

    import test.types as aas_types
    import test.verification as aas_verification

    an_instance = aas_types.ListOfPrimitives(
