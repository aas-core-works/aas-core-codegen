...
public class EnhancedEntity<EnhancementT>
  extends Enhanced<EnhancementT>
  implements IEntity {
  private final IEntity instance;
  ...
  public Optional<List<ISubmodelElement>> getStatements() {
    return instance.getStatements();
  }

  @Override
  public void setStatements(List<ISubmodelElement> statements) {
    instance.setStatements(statements);
  }
  ...
  public Iterable<ISubmodelElement> overStatementsOrEmpty() {
    return instance.overStatementsOrEmpty();
  }
  ...
  public <ContextT> void accept(
    ...
    visitor.visitEntity(instance, context);
  }

  public <T> T transform(ITransformer<T> transformer) {
    return transformer.transformEntity(instance);
  }
  ...
  public <ContextT, T> T transform(
    ...
    return transformer.transformEntity(instance, context);
  }
}
