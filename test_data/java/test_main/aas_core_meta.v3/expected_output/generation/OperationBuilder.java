...
/**
 * Builder for the Operation type.
 */
public class OperationBuilder {
  ...
  public OperationBuilder setExtensions(List<IExtension> extensions) {
    this.extensions = extensions;
    return this;
  }

  public OperationBuilder setCategory(String category) {
  ...
  public OperationBuilder setDescription(List<ILangStringTextType> description) {
  ...
  public OperationBuilder setQualifiers(List<IQualifier> qualifiers) {
