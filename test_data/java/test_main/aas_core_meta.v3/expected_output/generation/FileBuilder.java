...
public class FileBuilder {
  ...
  public FileBuilder(String contentType) {
    this.contentType = Objects.requireNonNull(
      contentType,
      "Argument \"contentType\" must be non-null.");
  }

  public FileBuilder setExtensions(List<IExtension> extensions) {
    this.extensions = extensions;
    return this;
  }

  public FileBuilder setCategory(String category) {
  ...
  public FileBuilder setDescription(List<ILangStringTextType> description) {
  ...
  public FileBuilder setQualifiers(List<IQualifier> qualifiers) {
  ...
  public FileBuilder setValue(String value) {
    this.value = value;
    return this;
  }
