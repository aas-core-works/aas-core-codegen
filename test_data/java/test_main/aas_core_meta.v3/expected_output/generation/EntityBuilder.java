...
public class EntityBuilder {
  ...
  public EntityBuilder setExtensions(List<IExtension> extensions) {
    this.extensions = extensions;
    return this;
  }

  public EntityBuilder setCategory(String category) {
  ...
  public EntityBuilder setDescription(List<ILangStringTextType> description) {
  ...
  public EntityBuilder setQualifiers(List<IQualifier> qualifiers) {
  ...
  public EntityBuilder setStatements(List<ISubmodelElement> statements) {
