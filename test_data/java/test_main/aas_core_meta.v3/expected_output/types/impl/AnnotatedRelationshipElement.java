...
import aas_core.aas3_0.types.model.IAnnotatedRelationshipElement;
import java.util.Collections;
import java.util.List;
import java.util.Objects;
 ...
 */
public class AnnotatedRelationshipElement implements IAnnotatedRelationshipElement {
  /**
  ...
  @Override
  public Optional<List<IDataElement>> getAnnotations() {
    return Optional.ofNullable(annotations);
  }

  @Override
  public void setAnnotations(List<IDataElement> annotations) {
    this.annotations = annotations;
  }

  /**
   * Iterate over {@link AnnotatedRelationshipElement#extensions}, if set,
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#displayName}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#description}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#supplementalSemanticIds}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#qualifiers}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#embeddedDataSpecifications}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#annotations}, if set,
   * and otherwise return an empty iterator.
   */
  public Iterable<IDataElement> overAnnotationsOrEmpty() {
    return getAnnotations().orElseGet(Collections::emptyList);
  }
  ...
  private class AnnotatedRelationshipElementIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (semanticId != null) {
        memberStream = Stream.concat(memberStream,
          Stream.<IClass>of(AnnotatedRelationshipElement.this.semanticId));
      }
      ...
      if (first != null) {
        memberStream = Stream.concat(memberStream,
          Stream.<IClass>of(AnnotatedRelationshipElement.this.first));
      }

      if (second != null) {
        memberStream = Stream.concat(memberStream,
          Stream.<IClass>of(AnnotatedRelationshipElement.this.second));
      }
  ...
  private class AnnotatedRelationshipElementRecursiveIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (semanticId != null) {
        memberStream = Stream.concat(memberStream,
          Stream.concat(Stream.<IClass>of(AnnotatedRelationshipElement.this.semanticId),
            StreamSupport.stream(AnnotatedRelationshipElement.this.semanticId.descend().spliterator(), false)));
      }
      ...
      if (first != null) {
        memberStream = Stream.concat(memberStream,
          Stream.concat(Stream.<IClass>of(AnnotatedRelationshipElement.this.first),
            StreamSupport.stream(AnnotatedRelationshipElement.this.first.descend().spliterator(), false)));
      }

      if (second != null) {
        memberStream = Stream.concat(memberStream,
          Stream.concat(Stream.<IClass>of(AnnotatedRelationshipElement.this.second),
            StreamSupport.stream(AnnotatedRelationshipElement.this.second.descend().spliterator(), false)));
      }
