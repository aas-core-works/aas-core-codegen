...
namespace AasCore.Aas3
{
    ...
    public static class Xmlization
    {
        ...
        internal static class DeserializeImplementation
        {
            ...
            /// <summary>
            /// Deserialize an instance of class View from a sequence of XML elements.
            /// </summary>
            internal static Aas.View? ViewFromSequence(
                Xml.XmlReader reader,
                out Reporting.Error? error)
            {
                error = null;
                ...
                if (reader.EOF)
                {
                    error = new Reporting.Error(
                        "Expected an XML element representing " +
                        "a property of an instance of class View, " +
                        "but reached the end-of-file");
                    return null;
                }
                ...
                while (reader.NodeType == Xml.XmlNodeType.Element)
                {
                    ...
                    switch (elementName)
                    {
                        case "extensions":
                        {
                            if (reader.EOF)
                            {
                                error = new Reporting.Error(
                                    "Expected an XML content representing " +
                                    "the property Extensions of an instance of class View, " +
                                    "but reached the end-of-file");
                                return null;
                            }
                        ...
                        case "idShort":
                        {
                            if (reader.EOF)
                            {
                                error = new Reporting.Error(
                                    "Expected an XML content representing " +
                                    "the property IdShort of an instance of class View, " +
                                    "but reached the end-of-file");
                                return null;
                            }
                        ...
                        case "displayName":
                        {
                            if (reader.EOF)
                            {
                                error = new Reporting.Error(
                                    "Expected an XML content representing " +
                                    "the property DisplayName of an instance of class View, " +
                                    "but reached the end-of-file");
                                return null;
                            }
                        ...
                        case "category":
                        {
                            if (reader.EOF)
                            {
                                error = new Reporting.Error(
                                    "Expected an XML content representing " +
                                    "the property Category of an instance of class View, " +
                                    "but reached the end-of-file");
                                return null;
                            }
                        ...
                        case "description":
                        {
                            if (reader.EOF)
                            {
                                error = new Reporting.Error(
                                    "Expected an XML content representing " +
                                    "the property Description of an instance of class View, " +
                                    "but reached the end-of-file");
                                return null;
                            }
                        ...
                        case "checksum":
                        {
                            if (reader.EOF)
                            {
                                error = new Reporting.Error(
                                    "Expected an XML content representing " +
                                    "the property Checksum of an instance of class View, " +
                                    "but reached the end-of-file");
                                return null;
                            }
                        ...
                        case "semanticId":
                        {
                            if (reader.EOF)
                            {
                                error = new Reporting.Error(
                                    "Expected an XML content representing " +
                                    "the property SemanticId of an instance of class View, " +
                                    "but reached the end-of-file");
                                return null;
                            }
                        ...
                        case "dataSpecifications":
                        {
                            if (reader.EOF)
                            {
                                error = new Reporting.Error(
                                    "Expected an XML content representing " +
                                    "the property DataSpecifications of an instance of class View, " +
                                    "but reached the end-of-file");
                                return null;
                            }
                        ...
                        case "containedElements":
                        {
                            if (reader.EOF)
                            {
                                error = new Reporting.Error(
                                    "Expected an XML content representing " +
                                    "the property ContainedElements of an instance of class View, " +
                                    "but reached the end-of-file");
                                return null;
                            }

                            SkipWhitespaceAndComments(reader);
                            theContainedElements = new List<IReference>();

                            int indexContainedElements = 0;
                            while (reader.NodeType == Xml.XmlNodeType.Element)
                            {
                                IReference? item = IReferenceFromElement(
                                    reader,
                                    out error);
                        ...
                        default:
                            error = new Reporting.Error(
                                "We expected properties of the class View, " +
                                "but got an unexpected element " +
                                $"with the name {reader.Name}");
                            return null;
                    }
                    ...
                    {
                        error = new Reporting.Error(
                            $"Expected an XML end element to conclude a property of class View " +
                            $"with the element name {elementName}, " +
                            $"but got the end-of-file.");
                    }
                    if (reader.NodeType != Xml.XmlNodeType.EndElement)
            ...
            /// <summary>
            /// Deserialize an instance of class View from an XML element.
            /// </summary>
            internal static Aas.View? ViewFromElement(
                Xml.XmlReader reader,
                out Reporting.Error? error)
            {
                error = null;
                ...
                {
                    error = new Reporting.Error(
                        "Expected an XML element representing an instance of class View, " +
                        "but reached the end-of-file");
                    return null;
                }
                ...
                {
                    error = new Reporting.Error(
                        "Expected an element representing an instance of class View " +
                        $"with element name view, but got: {reader.Name}");
                    return null;
                }
                ...
                {
                    error = new Reporting.Error(
                        "Expected an XML end element concluding an instance of class View, " +
                        "but reached the end-of-file");
                    return null;
                }
        ...
        public static class Deserialize
        {
            ...
            /// <summary>
            /// Deserialize an instance of class View from <paramref name="reader" />.
            /// </summary>
            /// <param name="reader">Initialized XML reader with cursor set to the element</param>
            /// <exception cref="Xmlization.Exception">
            /// Thrown when <paramref name="node" /> is not a valid XML
            ...
            {
                Aas.View? result = (
                    DeserializeImplementation.ViewFromElement(
                        reader,
                        out Reporting.Error? error));
                if (error != null)
                {
