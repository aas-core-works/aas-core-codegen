...
def modelling_kind_from_str(text: str) -> Optional[aas_types.ModellingKind]:
    ...
    of :py:class:`aas_core3_rc02.ModellingKind`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_rc02.ModellingKind`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_rc02.ModellingKind`
