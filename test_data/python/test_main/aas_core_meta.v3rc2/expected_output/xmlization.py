...
def lang_string_from_iterparse(
    ...
    try:
        return _read_lang_string_as_element(
            next_element,
            iterator
        )
    except DeserializationException as exception:
...
def lang_string_from_stream(
    ...
    return lang_string_from_iterparse(
        _with_elements_cleared_after_yield(iterator)
    )
...
def data_specification_physical_unit_from_iterparse(
    ...
    try:
        return _read_data_specification_physical_unit_as_element(
            next_element,
            iterator
        )
    except DeserializationException as exception:
...
class _ReaderAndSetterForExtension:
    ...
    def read_and_set_refers_to(
        ...
        """
        self.refers_to = _read_reference_as_sequence(
            element,
            iterator
        )
...
class _ReaderAndSetterForAssetAdministrationShell:
    ...
    def read_and_set_display_name(
        ...
        while True:
            ...
            try:
                item = _read_lang_string_as_element(
                    next_element,
                    iterator
                )
            except DeserializationException as exception:
    ...
    def read_and_set_checksum(
        ...
        """
        self.checksum = _read_str_from_element_text(
            element,
            iterator
        )
...
class _ReaderAndSetterForAssetInformation:
    ...
    def read_and_set_global_asset_id(
        ...
        """
        self.global_asset_id = _read_reference_as_sequence(
            element,
            iterator
        )
...
class _ReaderAndSetterForSubmodel:
    ...
    def read_and_set_kind(
        ...
        """
        self.kind = _read_modeling_kind_from_element_text(
            element,
            iterator
        )
...
class _ReaderAndSetterForEntity:
    ...
    def read_and_set_specific_asset_id(
        ...
        """
        self.specific_asset_id = _read_specific_asset_id_as_sequence(
            element,
            iterator
        )
...
class _ReaderAndSetterForEventPayload:
    ...
    def read_and_set_payload(
        ...
        """
        self.payload = _read_str_from_element_text(
            element,
            iterator
        )
...
def _read_lang_string_as_element(
    ...
    return _read_lang_string_as_sequence(
        element,
        iterator
    )
...
class _ReaderAndSetterForDataSpecificationIEC61360:
    ...
    def read_and_set_level_type(
        ...
        """
        self.level_type = _read_level_type_from_element_text(
            element,
            iterator
        )
...
class _ReaderAndSetterForDataSpecificationPhysicalUnit:
    ...
    def read_and_set_unit_name(
        ...
        """
        self.unit_name = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_unit_symbol(
        ...
        """
        self.unit_symbol = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_si_notation(
        ...
        """
        self.si_notation = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_si_name(
        ...
        """
        self.si_name = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_din_notation(
        ...
        """
        self.din_notation = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_ece_name(
        ...
        """
        self.ece_name = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_ece_code(
        ...
        """
        self.ece_code = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_nist_name(
        ...
        """
        self.nist_name = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_conversion_factor(
        ...
        """
        self.conversion_factor = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_registration_authority_id(
        ...
        """
        self.registration_authority_id = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_supplier(
        ...
        """
        self.supplier = _read_str_from_element_text(
            element,
            iterator
        )
...
def _read_data_specification_physical_unit_as_sequence(
    ...
    while True:
        ...
        read_and_set_method = _READ_AND_SET_DISPATCH_FOR_DATA_SPECIFICATION_PHYSICAL_UNIT.get(
            tag_wo_ns,
            None
        )
        if read_and_set_method is None:
...
def _read_data_specification_physical_unit_as_element(
    ...
    return _read_data_specification_physical_unit_as_sequence(
        element,
        iterator
    )
...
_READ_AND_SET_DISPATCH_FOR_ASSET_ADMINISTRATION_SHELL: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForAssetAdministrationShell.read_and_set_checksum,
    'administration':
...
_READ_AND_SET_DISPATCH_FOR_SUBMODEL: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForSubmodel.read_and_set_checksum,
    'administration':
...
_READ_AND_SET_DISPATCH_FOR_RELATIONSHIP_ELEMENT: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForRelationshipElement.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForRelationshipElement.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_SUBMODEL_ELEMENT_LIST: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForSubmodelElementList.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForSubmodelElementList.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_SUBMODEL_ELEMENT_COLLECTION: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForSubmodelElementCollection.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForSubmodelElementCollection.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_PROPERTY: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForProperty.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForProperty.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_MULTI_LANGUAGE_PROPERTY: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForMultiLanguageProperty.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForMultiLanguageProperty.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_RANGE: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForRange.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForRange.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_REFERENCE_ELEMENT: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForReferenceElement.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForReferenceElement.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_BLOB: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForBlob.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForBlob.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_FILE: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForFile.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForFile.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_ANNOTATED_RELATIONSHIP_ELEMENT: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForAnnotatedRelationshipElement.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForAnnotatedRelationshipElement.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_ENTITY: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForEntity.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForEntity.read_and_set_kind,
    'semanticId':
    ...
    'specificAssetId':
        _ReaderAndSetterForEntity.read_and_set_specific_asset_id,
}
...
_READ_AND_SET_DISPATCH_FOR_BASIC_EVENT_ELEMENT: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForBasicEventElement.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForBasicEventElement.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_OPERATION: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForOperation.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForOperation.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_CAPABILITY: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForCapability.read_and_set_checksum,
    'kind':
        _ReaderAndSetterForCapability.read_and_set_kind,
    'semanticId':
...
_READ_AND_SET_DISPATCH_FOR_CONCEPT_DESCRIPTION: Mapping[
    ...
    'checksum':
        _ReaderAndSetterForConceptDescription.read_and_set_checksum,
    'administration':
...
_READ_AND_SET_DISPATCH_FOR_LANG_STRING: Mapping[
    ...
    'language':
        _ReaderAndSetterForLangString.read_and_set_language,
    'text':
        _ReaderAndSetterForLangString.read_and_set_text,
}
...
_READ_AND_SET_DISPATCH_FOR_DATA_SPECIFICATION_PHYSICAL_UNIT: Mapping[
    ...
    'unitName':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_unit_name,
    'unitSymbol':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_unit_symbol,
    'definition':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_definition,
    'siNotation':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_si_notation,
    'siName':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_si_name,
    'dinNotation':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_din_notation,
    'eceName':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_ece_name,
    'eceCode':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_ece_code,
    'nistName':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_nist_name,
    'sourceOfDefinition':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_source_of_definition,
    'conversionFactor':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_conversion_factor,
    'registrationAuthorityId':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_registration_authority_id,
    'supplier':
        _ReaderAndSetterForDataSpecificationPhysicalUnit.read_and_set_supplier,
}
...
class _Serializer(aas_types.AbstractVisitor):
    ...
    def _write_lang_string_as_sequence(
        self,
    ...
    def visit_lang_string(
        ...
        self._write_lang_string_as_sequence(
            that
        )
    ...
    def _write_data_specification_physical_unit_as_sequence(
        self,
        that: aas_types.DataSpecificationPhysicalUnit
    ) -> None:
        """
        Serialize :paramref:`that` to :py:attr:`~stream` as a sequence of
        XML elements.
        ...
        if that.conversion_factor is not None:
            self._write_str_property(
                'conversionFactor',
                that.conversion_factor
            )

        if that.registration_authority_id is not None:
            self._write_str_property(
                'registrationAuthorityId',
                that.registration_authority_id
            )
    ...
    def visit_data_specification_physical_unit(
        ...
        self._write_data_specification_physical_unit_as_sequence(
            that
        )
