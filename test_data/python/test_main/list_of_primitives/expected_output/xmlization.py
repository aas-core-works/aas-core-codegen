...
def list_of_primitives_from_iterparse(
    ...
    try:
        return _read_list_of_primitives_as_element(
            next_element,
            iterator
        )
...
def _read_list_of_primitives_as_sequence(
    ...
    reader_and_setter = (
        _ReaderAndSetterForListOfPrimitives()
    )
...
def _read_list_of_primitives_as_element(
    ...
    return _read_list_of_primitives_as_sequence(
        element,
        iterator
    )
...
_READ_AND_SET_DISPATCH_FOR_LIST_OF_PRIMITIVES: Mapping[
    ...
    'strings':
        _ReaderAndSetterForListOfPrimitives.read_and_set_strings,
    'integers':
        _ReaderAndSetterForListOfPrimitives.read_and_set_integers,
    'booleans':
        _ReaderAndSetterForListOfPrimitives.read_and_set_booleans,
}
...
class _Serializer(aas_types.AbstractVisitor):
    ...
    def visit_list_of_primitives(
        ...
        self._write_list_of_primitives_as_sequence(
            that
        )
