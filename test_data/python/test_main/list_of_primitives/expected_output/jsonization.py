...
def list_of_primitives_from_jsonable(
        jsonable: Jsonable
    ...
    for key, jsonable_value in jsonable.items():
        setter_method = (
            _SETTER_MAP_FOR_LIST_OF_PRIMITIVES.get(key)
        )
...
_SETTER_MAP_FOR_LIST_OF_PRIMITIVES: Mapping[
    str,
    Callable[
        [_SetterForListOfPrimitives, Jsonable],
        None
    ]
] = {
    'strings':
        _SetterForListOfPrimitives.set_strings_from_jsonable,
    'integers':
        _SetterForListOfPrimitives.set_integers_from_jsonable,
    'booleans':
        _SetterForListOfPrimitives.set_booleans_from_jsonable,
    'modelType':
        _SetterForListOfPrimitives.ignore
}
