...
import aas_core_csharp_codegen.rdf_shacl.main
    ...
    def test_cases(self) -> None:
        ...
        for case_dir in parent_case_dir.iterdir():
            ...
            with contextlib.ExitStack() as exit_stack:
                ...
                params = aas_core_csharp_codegen.rdf_shacl.main.Parameters(
                ...
                return_code = aas_core_csharp_codegen.rdf_shacl.main.run(
