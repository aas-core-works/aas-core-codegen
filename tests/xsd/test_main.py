...
import aas_core_csharp_codegen.xsd.main
...
class Test_against_recorded(unittest.TestCase):
    ...
    def test_cases(self) -> None:
        ...
        parent_case_dir = repo_dir / "test_data" / "test_xsd" / "test_main"
        ...
        for case_dir in parent_case_dir.iterdir():
            ...
            with contextlib.ExitStack() as exit_stack:
                ...
                params = aas_core_csharp_codegen.xsd.main.Parameters(
                ...
                return_code = aas_core_csharp_codegen.xsd.main.run(
