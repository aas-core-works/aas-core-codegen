...
.. code-block::
    ...
    usage: aas-core-codegen [-h] --model_path MODEL_PATH --snippets_dir
                            ...
                            {cpp,csharp,golang,java,jsonld_context,jsonschema,opcua,protobuf,python,python_protobuf,rdf_shacl,typescript,xsd}
                            [--cache_model] [--version]
    ...
    options:
      ...
      --target {cpp,csharp,golang,java,jsonld_context,jsonschema,opcua,protobuf,python,python_protobuf,rdf_shacl,typescript,xsd}
