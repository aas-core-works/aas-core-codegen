...
public class RangeBuilder {
  ...
  public RangeBuilder(DataTypeDefXsd valueType) {
    this.valueType = Objects.requireNonNull(
      valueType,
      "Argument \"valueType\" must be non-null.");
  }

  public RangeBuilder setExtensions(List<IExtension> extensions) {
    this.extensions = extensions;
    return this;
  }

  public RangeBuilder setCategory(String category) {
  ...
  public RangeBuilder setDescription(List<ILangStringTextType> description) {
  ...
  public RangeBuilder setQualifiers(List<IQualifier> qualifiers) {
  ...
  public RangeBuilder setMin(String min) {
    this.min = min;
    return this;
  }

  public RangeBuilder setMax(String max) {
    this.max = max;
    return this;
  }
