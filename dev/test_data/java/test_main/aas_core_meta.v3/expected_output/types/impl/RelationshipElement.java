 ...
 */
public class RelationshipElement implements IRelationshipElement {
  /**
  ...
  /**
   * Iterate over {@link RelationshipElement#extensions}, if set,
  ...
  /**
   * Iterate over {@link RelationshipElement#displayName}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link RelationshipElement#description}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link RelationshipElement#supplementalSemanticIds}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link RelationshipElement#qualifiers}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link RelationshipElement#embeddedDataSpecifications}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  private class RelationshipElementIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (semanticId != null) {
        memberStream = Stream.concat(memberStream,
          Stream.<IClass>of(RelationshipElement.this.semanticId));
      }
      ...
      if (first != null) {
        memberStream = Stream.concat(memberStream,
          Stream.<IClass>of(RelationshipElement.this.first));
      }

      if (second != null) {
        memberStream = Stream.concat(memberStream,
          Stream.<IClass>of(RelationshipElement.this.second));
      }
  ...
  private class RelationshipElementRecursiveIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (semanticId != null) {
        memberStream = Stream.concat(memberStream,
          Stream.concat(Stream.<IClass>of(RelationshipElement.this.semanticId),
            StreamSupport.stream(RelationshipElement.this.semanticId.descend().spliterator(), false)));
      }
      ...
      if (first != null) {
        memberStream = Stream.concat(memberStream,
          Stream.concat(Stream.<IClass>of(RelationshipElement.this.first),
            StreamSupport.stream(RelationshipElement.this.first.descend().spliterator(), false)));
      }

      if (second != null) {
        memberStream = Stream.concat(memberStream,
          Stream.concat(Stream.<IClass>of(RelationshipElement.this.second),
            StreamSupport.stream(RelationshipElement.this.second.descend().spliterator(), false)));
      }
