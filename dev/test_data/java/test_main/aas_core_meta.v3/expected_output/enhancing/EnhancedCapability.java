...
public class EnhancedCapability<EnhancementT>
  extends Enhanced<EnhancementT>
  implements ICapability {
  private final ICapability instance;

  public EnhancedCapability(
    ICapability instance,
  ...
  public void accept(IVisitor visitor) {
    visitor.visitCapability(instance);
  }
  ...
  public <ContextT> void accept(
    ...
    visitor.visitCapability(instance, context);
  }

  public <T> T transform(ITransformer<T> transformer) {
    return transformer.transformCapability(instance);
  }
  ...
  public <ContextT, T> T transform(
    ...
    return transformer.transformCapability(instance, context);
  }
}
