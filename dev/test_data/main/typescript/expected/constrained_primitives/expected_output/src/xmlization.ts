  ...
  while (true) {
    ...
    switch (propertyLocalName) {
      case "someBool": {
        ...
        theSomeBool = parsedOrError.mustValue();
        break;
      }
      ...
      case "someInt": {
        ...
        theSomeInt = parsedOrError.mustValue();
        break;
      }
      ...
      case "someFloat": {
        ...
        const parsedOrError = parseFloatText(textOrError.mustValue());
        if (parsedOrError.error !== null) {
          propertyError = parsedOrError.error;
          break;
        }

        theSomeFloat = parsedOrError.mustValue();
        break;
      }
      ...
      case "someString": {
        ...
        theSomeString = parsedOrError.mustValue();
        break;
      }
      ...
      case "someBytes": {
        ...
        theSomeBytes = parsedOrError.mustValue();
        break;
      }
