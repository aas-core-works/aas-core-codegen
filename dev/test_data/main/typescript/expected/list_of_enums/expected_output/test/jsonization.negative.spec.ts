...
test("Something deserialization fails with missing required property", () => {
...
test("Something deserialization fails with property type mismatch", () => {
  const jsonable = readExpectedJson(
    "Something",
    "minimal.json"
  );
  ...
  const jsonObject = { ...mustBeJsonObject(jsonable) };
  jsonObject["someResults"] = { definitely: "unexpected-object" };
