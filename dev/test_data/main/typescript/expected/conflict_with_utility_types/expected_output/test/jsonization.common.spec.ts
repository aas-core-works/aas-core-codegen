...
test("commonJsonization loaders for ReadonlY", () => {
  expect(TestCommonJsonization.loadMinimalReadonly()).not.toBeNull();
  expect(TestCommonJsonization.loadMaximalReadonly()).not.toBeNull();
});
