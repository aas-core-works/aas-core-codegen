...
test("model type of ReadonlY", () => {
  const instance = TestCommonJsonization.loadMinimalReadonly();
...
test("model type from string of ReadonlY", () => {
  const text = "Readonly";
...
test("model type to string of ReadonlY", () => {
