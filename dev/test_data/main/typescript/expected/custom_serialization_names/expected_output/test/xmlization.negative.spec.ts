...
test("XML namespace mismatch fails", () => {
  const pth = path.join(
    TestCommon.TEST_DATA_DIR, "Xml", "Expected", "queryCondition", "minimal.xml"
  );
