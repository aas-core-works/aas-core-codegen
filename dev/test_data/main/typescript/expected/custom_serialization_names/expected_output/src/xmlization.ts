 ...
 */
function parseQueryConditionFromSequence(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.QueryCondition, DeserializationError> {
  ...
  while (true) {
    ...
    switch (propertyLocalName) {
      ...
      case "not-eq": {
        ...
        theNotEq = parsedOrError.mustValue();
        break;
      }
  ...
  const instance = new AasTypes.QueryCondition(
    theEq,
    theNotEq
  );
  return new AasCommon.Either<AasTypes.QueryCondition, DeserializationError>(
...
const ROOT_DISPATCH_BY_LOCAL_NAME =
  ...
  >([
    [
      "queryCondition",
      parseQueryConditionFromSequence
    ]
  ]);
