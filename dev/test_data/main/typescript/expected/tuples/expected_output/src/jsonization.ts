...
class SetterForSomething {
    ...
    if (array.length !== 2) {
      return new DeserializationError(
        `Expected exactly 2 item(s) in the array, ` +
          `but got: ${array.length}`
      );
    }

    const item0OrError = stringFromJsonable(
      array[0]
    );
    if (item0OrError.error !== null) {
      item0OrError.error.path.prepend(
        new IndexSegment(
          array,
          0
        )
      );
      return item0OrError.error;
    }

    const item1OrError = integerFromJsonable(
      array[1]
    );
    if (item1OrError.error !== null) {
      item1OrError.error.path.prepend(
        new IndexSegment(
          array,
          1
        )
      );
      return item1OrError.error;
    }
  ...
  setItemsFromJsonable(
    ...
    const item0OrError = abstractItemFromJsonable(
      array[0]
    );
    if (item0OrError.error !== null) {
      item0OrError.error.path.prepend(
    ...
    const item1OrError = abstractItemFromJsonable(
      array[1]
    );
    if (item1OrError.error !== null) {
      item1OrError.error.path.prepend(
  ...
  setTrickyFromJsonable(
    ...
    const item0OrError = integerFromJsonable(
      array[0]
    );
    if (item0OrError.error !== null) {
      item0OrError.error.path.prepend(
    ...
    const item1OrError = someItemFromJsonable(
      array[1]
    );
    if (item1OrError.error !== null) {
      item1OrError.error.path.prepend(
    ...
    const item2OrError = abstractItemFromJsonable(
      array[2]
    );
    if (item2OrError.error !== null) {
      item2OrError.error.path.prepend(
        new IndexSegment(
          array,
          2
        )
      );
      return item2OrError.error;
    }

    const item3OrError = someItemFromJsonable(
      array[3]
    );
    if (item3OrError.error !== null) {
      item3OrError.error.path.prepend(
        new IndexSegment(
          array,
          3
        )
      );
      return item3OrError.error;
    }

    const item4OrError = integerFromJsonable(
      array[4]
    );
    if (item4OrError.error !== null) {
      item4OrError.error.path.prepend(
        new IndexSegment(
          array,
          4
        )
      );
      return item4OrError.error;
    }

    const item5OrError = resultFromJsonable(
      array[5]
    );
    if (item5OrError.error !== null) {
      item5OrError.error.path.prepend(
        new IndexSegment(
          array,
          5
        )
      );
      return item5OrError.error;
    }
