  ...
  while (true) {
    ...
    switch (propertyLocalName) {
      case "someBools": {
        ...
        const parsedItemsOrError = parseList<boolean>(
          cursor,
          (aCursor) => parseNamedVElement(aCursor, "v", parseBooleanText)
        );
        ...
        theSomeBools = parsedItemsOrError.mustValue();
        break;
      }
      ...
      case "someInts": {
        ...
        const parsedItemsOrError = parseList<number>(
          cursor,
          (aCursor) => parseNamedVElement(aCursor, "v", parseIntegerText)
        );
        if (parsedItemsOrError.error !== null) {
          propertyError = parsedItemsOrError.error;
          break;
        ...
        theSomeInts = parsedItemsOrError.mustValue();
        break;
      }
      ...
      case "someFloats": {
        ...
        const parsedItemsOrError = parseList<number>(
          cursor,
          (aCursor) => parseNamedVElement(aCursor, "v", parseFloatText)
        );
        if (parsedItemsOrError.error !== null) {
          propertyError = parsedItemsOrError.error;
          break;
        ...
        theSomeFloats = parsedItemsOrError.mustValue();
        break;
      }
      ...
      case "someStrings": {
        ...
        const parsedItemsOrError = parseList<string>(
          cursor,
          (aCursor) => parseNamedVElement(aCursor, "v", parseStringText)
        );
        if (parsedItemsOrError.error !== null) {
          propertyError = parsedItemsOrError.error;
          break;
        ...
        theSomeStrings = parsedItemsOrError.mustValue();
        break;
      }
      ...
      case "someBytes": {
        ...
        const parsedItemsOrError = parseList<Uint8Array>(
          cursor,
          (aCursor) => parseNamedVElement(aCursor, "v", parseBase64EncodedBytesText)
        );
        if (parsedItemsOrError.error !== null) {
          propertyError = parsedItemsOrError.error;
          break;
        ...
        theSomeBytes = parsedItemsOrError.mustValue();
        break;
      }
