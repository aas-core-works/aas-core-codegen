...
test("Branch deserialization fail", () => {
  for (
    const causeDir of
...
test("Blossom deserialization fail", () => {
  for (
    const causeDir of
    TestCommon.findImmediateSubdirectories(
      path.join(
...
test("Blossom verification fail", () => {
  for (
    const causeDir of
    TestCommon.findImmediateSubdirectories(
      path.join(
