...
export function *overModelType (
  ...
  yield <ModelType>1;  // AnotherItem
  yield <ModelType>2;  // Simple
...
export interface IAbstractItem extends Class {
  // Intentionally empty.
}

export class SomeItem
  extends Class
  implements IAbstractItem {
  /**
  ...
  *descend(): IterableIterator<Class> {
  ...
  acceptWithContext<ContextT>(
    ...
    visitor.visitSomeItemWithContext(this, context);
  }
  ...
  transformWithContext<ContextT, T>(
    ...
    return transformer.transformSomeItemWithContext(
      this, context
    );
  }
...
export class AnotherItem
  ...
  *descend(): IterableIterator<Class> {
  ...
  acceptWithContext<ContextT>(
    ...
    visitor.visitAnotherItemWithContext(this, context);
  }
  ...
  transformWithContext<ContextT, T>(
    ...
    return transformer.transformAnotherItemWithContext(
      this, context
    );
  }
...
export class Simple extends Class {
  ...
  *descend(): IterableIterator<Class> {
  ...
  acceptWithContext<ContextT>(
    ...
    visitor.visitSimpleWithContext(this, context);
  }
  ...
  transformWithContext<ContextT, T>(
    ...
    return transformer.transformSimpleWithContext(
      this, context
    );
  }
...
export abstract class AbstractVisitorWithContext<ContextT> {
   ...
   * @param context - of the visitation
   */
  abstract visitSomeItemWithContext(
    that: SomeItem,
    context: ContextT
  ): void;
   ...
   * @param context - of the visitation
   */
  abstract visitAnotherItemWithContext(
    that: AnotherItem,
    context: ContextT
  ): void;
   ...
   * @param context - of the visitation
   */
  abstract visitSimpleWithContext(
    that: Simple,
    context: ContextT
  ): void;
...
export abstract class AbstractTransformerWithContext<ContextT, T> {
   ...
   * @returns transformed `that`
   */
  abstract transformSomeItemWithContext(
    that: SomeItem,
    context: ContextT
  ): T;
   ...
   * @returns transformed `that`
   */
  abstract transformAnotherItemWithContext(
    that: AnotherItem,
    context: ContextT
  ): T;
   ...
   * @returns transformed `that`
   */
  abstract transformSimpleWithContext(
    that: Simple,
    context: ContextT
  ): T;
...
/**
 * Try to cast an instance of the model to {@link IAbstractItem}.
 */
class AsAbstractItemTransformer
    extends AbstractTransformer<IAbstractItem | null> {
  transformSomeItem(
    that: SomeItem
  ): IAbstractItem | null {
    return that as IAbstractItem;
  }
...
const AS_ABSTRACT_ITEM_TRANSFORMER =
  new AsAbstractItemTransformer();

/**
 * Try to cast `that` instance to
 * the interface {@link IAbstractItem}.
 *
 * @param that - instance to be casted
 * @returns - casted `that` if cast successful, or `null`
 */
export function asAbstractItem(
  that: Class
): IAbstractItem | null {
  return AS_ABSTRACT_ITEM_TRANSFORMER.transform(that);
}
 ...
 */
export function isAbstractItem(
  that: Class
): that is IAbstractItem {
  return asAbstractItem(that) !== null;
}

/**
 * Try to cast `that` instance to
 * the class {@link SomeItem}.
 *
 * @param that - instance to be casted
 * @returns - casted `that` if cast successful, or `null`
 */
export function asSomeItem(
  that: Class
): SomeItem | null {
  return (that instanceof SomeItem)
    ? <SomeItem>that
    : null;
}
...
/**
 * Try to cast `that` instance to
 * the class {@link AnotherItem}.
 *
 * @param that - instance to be casted
 * @returns - casted `that` if cast successful, or `null`
 */
export function asAnotherItem(
  that: Class
): AnotherItem | null {
  return (that instanceof AnotherItem)
    ? <AnotherItem>that
    : null;
}
