...
test("descendOnce of SomeItem", () => {
  const instance = TestCommonJsonization.loadMaximalSomeItem();
...
test("descendOnce of AnotherItem", () => {
  const instance = TestCommonJsonization.loadMaximalAnotherItem();
...
test("descendOnce of Simple", () => {
  const instance = TestCommonJsonization.loadMaximalSimple();
