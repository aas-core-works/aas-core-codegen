...
public class Xmlization {
  ...
  private static class _DeserializeImplementation
  {
     ...
     * of {@link Result}.
     */
    private static _Result<Result> tryNamedElementAsResult(
      XMLEventReader reader, String expectedName) {
          ...
          switch (tryElementName.getResult()) {
            case "pair":
            {
              if (isEmptyProperty) {
                ...
                error.prependSegment(new Reporting.NameSegment("pair"));
                return _Result.failure(error);
              }

              final _Result<? extends String> itemPair0Result =
                tryNamedElementAsString(reader, "v1");
              ...
              final _Result<? extends Long> itemPair1Result =
                tryNamedElementAsLong(reader, "v2");
            ...
            case "items":
            {
              if (isEmptyProperty) {
                final Reporting.Error error = new Reporting.Error(
                  "Expected exactly 2 item(s), but got a self-closing element");
                error.prependSegment(new Reporting.NameSegment("items"));
                return _Result.failure(error);
              }
              ...
              if (!currentEvent(reader).isStartElement()) {
                ...
                error.prependSegment(new Reporting.IndexSegment(0));
                error.prependSegment(new Reporting.NameSegment("items"));
                return _Result.failure(error);
              }
              final _Result<? extends IAbstractItem> itemItems0Result = tryIAbstractItemFromElement(reader);
              ...
              if (!currentEvent(reader).isStartElement()) {
                final Reporting.Error error = new Reporting.Error(
                  "Expected a start element opening an instance of IAbstractItem, but got an XML "
                    + getEventTypeAsString(currentEvent(reader)));
                error.prependSegment(new Reporting.IndexSegment(1));
                error.prependSegment(new Reporting.NameSegment("items"));
                return _Result.failure(error);
              }
              final _Result<? extends IAbstractItem> itemItems1Result = tryIAbstractItemFromElement(reader);
            ...
            case "tricky":
            {
              if (isEmptyProperty) {
                ...
                error.prependSegment(new Reporting.NameSegment("tricky"));
                return _Result.failure(error);
              }

              final _Result<? extends Long> itemTricky0Result =
                tryNamedElementAsLong(reader, "v1");
              ...
              if (!currentEvent(reader).isStartElement()) {
                final Reporting.Error error = new Reporting.Error(
                  "Expected a start element opening an instance of ISomeItem, but got an XML "
                    + getEventTypeAsString(currentEvent(reader)));
                error.prependSegment(new Reporting.IndexSegment(1));
                error.prependSegment(new Reporting.NameSegment("tricky"));
                return _Result.failure(error);
              }
              final _Result<? extends ISomeItem> itemTricky1Result = trySomeItemFromElement(reader);
              ...
              if (!currentEvent(reader).isStartElement()) {
                final Reporting.Error error = new Reporting.Error(
                  "Expected a start element opening an instance of IAbstractItem, but got an XML "
                    + getEventTypeAsString(currentEvent(reader)));
                error.prependSegment(new Reporting.IndexSegment(2));
                error.prependSegment(new Reporting.NameSegment("tricky"));
                return _Result.failure(error);
              }
              final _Result<? extends IAbstractItem> itemTricky2Result = tryIAbstractItemFromElement(reader);
              ...
              if (!currentEvent(reader).isStartElement()) {
                final Reporting.Error error = new Reporting.Error(
                  "Expected a start element opening an instance of ISomeItem, but got an XML "
                    + getEventTypeAsString(currentEvent(reader)));
                error.prependSegment(new Reporting.IndexSegment(3));
                error.prependSegment(new Reporting.NameSegment("tricky"));
                return _Result.failure(error);
              }
              final _Result<? extends ISomeItem> itemTricky3Result = trySomeItemFromElement(reader);
              ...
              final _Result<? extends Long> itemTricky4Result =
                tryNamedElementAsLong(reader, "v5");
              ...
              final _Result<? extends Result> itemTricky5Result =
                tryNamedElementAsResult(reader, "v6");
  ...
  static class _VisitorWithWriter
    ...
    private void somethingToSequence(
      ...
      try {
        ...
        writer.writeCharacters(that.getPair().item1().toString());
        writer.writeEndElement();
        writer.writeStartElement("v2");
        writer.writeCharacters(that.getPair().item2().toString());
        writer.writeEndElement();
      ...
      try {
        ...
        this.visit(that.getItems().item1(), writer);
        this.visit(that.getItems().item2(), writer);
      ...
      try {
        ...
        writer.writeStartElement("v1");
        writer.writeCharacters(that.getTricky().item1().toString());
        writer.writeEndElement();
        this.visit(that.getTricky().item2(), writer);
        this.visit(that.getTricky().item3(), writer);
        this.visit(that.getTricky().item4(), writer);
        writer.writeStartElement("v5");
        writer.writeCharacters(that.getTricky().item5().toString());
        writer.writeEndElement();
        writer.writeStartElement("v6");
        final Optional<String> itemText = Stringification.toString(that.getTricky().item6());
        if (!itemText.isPresent()) {
          throw new IllegalArgumentException(
            "Invalid literal for the enumeration Result: " + that.getTricky().item6().toString());
        }
