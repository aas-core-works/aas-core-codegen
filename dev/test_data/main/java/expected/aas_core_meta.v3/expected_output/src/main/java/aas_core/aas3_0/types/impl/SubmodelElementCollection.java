...
import aas_core.aas3_0.types.model.ISubmodelElementCollection;
import java.util.Collections;
import java.util.List;
import java.util.Objects;
 ...
 */
public class SubmodelElementCollection implements ISubmodelElementCollection {
  /**
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#extensions}, if set,
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#displayName}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#description}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#supplementalSemanticIds}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#qualifiers}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#embeddedDataSpecifications}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#value}, if set,
   * and otherwise return an empty iterator.
   */
  ...
  public Iterable<IClass> descend() {
    return new _SubmodelElementCollectionRecursiveIterable();
  }
  ...
  public Iterable<IClass> descendOnce() {
    return new _SubmodelElementCollectionIterable();
  }
  ...
  private class _SubmodelElementCollectionIterable implements Iterable<IClass> {
    @Override
    ...
    private Stream<IClass> stream() {
      ...
      if (semanticId != null) {
        memberStream = Stream.concat(memberStream,
          Stream.<IClass>of(SubmodelElementCollection.this.semanticId));
      }
  ...
  private class _SubmodelElementCollectionRecursiveIterable implements Iterable<IClass> {
    @Override
    public Iterator<IClass> iterator() {
      Stream<IClass> stream = stream();
    ...
    private Stream<IClass> stream() {
      ...
      if (semanticId != null) {
        memberStream = Stream.concat(memberStream,
          Stream.concat(Stream.<IClass>of(SubmodelElementCollection.this.semanticId),
            StreamSupport.stream(SubmodelElementCollection.this.semanticId.descend().spliterator(), false)));
      }
