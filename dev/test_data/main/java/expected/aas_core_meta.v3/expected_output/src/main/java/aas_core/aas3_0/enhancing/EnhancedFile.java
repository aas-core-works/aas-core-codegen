...
public class EnhancedFile<EnhancementT>
  extends Enhanced<EnhancementT>
  implements IFile {
  private final IFile instance;
  ...
  public <ContextT> void accept(
    ...
    visitor.visitFile(instance, context);
  }

  public <T> T transform(ITransformer<T> transformer) {
    return transformer.transformFile(instance);
  }
  ...
  public <ContextT, T> T transform(
    ...
    return transformer.transformFile(instance, context);
  }
}
