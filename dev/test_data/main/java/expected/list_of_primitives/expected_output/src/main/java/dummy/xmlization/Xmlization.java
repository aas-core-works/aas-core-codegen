            ...
            case "someBools":
            {
              ...
              if (!isEmptyProperty) {
                ...
                while (currentEvent(reader).isStartElement()) {
                  ...
                  _Result<? extends Boolean> itemResult = tryNamedElementAsBoolean(reader, "v");
            ...
            case "someInts":
            {
              ...
              if (!isEmptyProperty) {
                ...
                while (currentEvent(reader).isStartElement()) {
                  ...
                  _Result<? extends Long> itemResult = tryNamedElementAsLong(reader, "v");
            ...
            case "someFloats":
            {
              ...
              if (!isEmptyProperty) {
                ...
                while (currentEvent(reader).isStartElement()) {
                  ...
                  _Result<? extends Double> itemResult = tryNamedElementAsDouble(reader, "v");
            ...
            case "someStrings":
            {
              ...
              if (!isEmptyProperty) {
                ...
                while (currentEvent(reader).isStartElement()) {
                  ...
                  _Result<? extends String> itemResult = tryNamedElementAsString(reader, "v");
            ...
            case "someBytes":
            {
              ...
              if (!isEmptyProperty) {
                ...
                while (currentEvent(reader).isStartElement()) {
                  ...
                  _Result<? extends byte[]> itemResult = tryNamedElementAsBytes(reader, "v");
      ...
      try {
        ...
        for (byte[] item : that.getSomeBytes()) {
          ...
          writer.writeCharacters(
            Base64.getEncoder().encodeToString(item));
          writer.writeEndElement();
        }
