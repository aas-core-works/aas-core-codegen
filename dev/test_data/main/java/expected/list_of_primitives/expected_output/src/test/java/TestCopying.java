...
public class TestCopying {
  private static class _DeepEqualiser extends AbstractTransformerWithContext<IClass, Boolean> {
    ...
    public Boolean transformSomething(ISomething that, IClass other) {
      ...
      return (
        that.getSomeBools().equals(casted.getSomeBools())
        && that.getSomeInts().equals(casted.getSomeInts())
        && that.getSomeFloats().equals(casted.getSomeFloats())
        && that.getSomeStrings().equals(casted.getSomeStrings())
        && (that.getSomeBytes().size() == casted.getSomeBytes().size()
          && zip(that.getSomeBytes().stream(), casted.getSomeBytes().stream())
            .allMatch(pair -> Arrays.equals(pair.getFirst(), pair.getSecond()))));
    }
  ...
  private static Boolean SomethingShallowEquals(
    ...
    Something other) {
    return (
      that.getSomeBools().equals(other.getSomeBools())
      && that.getSomeInts().equals(other.getSomeInts())
      && that.getSomeFloats().equals(other.getSomeFloats())
      && that.getSomeStrings().equals(other.getSomeStrings())
      && that.getSomeBytes().equals(other.getSomeBytes()));
  }
