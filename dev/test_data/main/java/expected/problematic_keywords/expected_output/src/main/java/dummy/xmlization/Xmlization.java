          ...
          switch (tryElementName.getResult()) {
            case "interface":
            {
              if (isEmptyProperty) {
                ...
                try {
                  theInterface = readContentAsString(reader);
                } catch (Exception e) {
                  final Reporting.Error error = new Reporting.Error(
                    "The property interfacE of an instance of class Something "
            ...
            case "range":
            {
              if (isEmptyProperty) {
                ...
                try {
                  theRange = readContentAsString(reader);
                } catch (Exception e) {
                  final Reporting.Error error = new Reporting.Error(
                    "The property range of an instance of class Something "
                      + " could not be de-serialized: " + e.getMessage());
            ...
            case "void":
            {
              if (isEmptyProperty) {
                ...
                try {
                  theVoid = readContentAsString(reader);
                } catch (Exception e) {
                  final Reporting.Error error = new Reporting.Error(
                    "The property voiD of an instance of class Something "
                      + " could not be de-serialized: " + e.getMessage());
