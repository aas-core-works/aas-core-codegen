...
public class TestCopying {
  private static class DeepEqualiser extends AbstractTransformerWithContext<IClass, Boolean> {
    ...
    public Boolean transformSomething(ISomething that, IClass other) {
      ...
      return (
        that.getInterface().equals(casted.getInterface())
  ...
  private static Boolean SomethingShallowEquals(
    ...
    Something other) {
    return (
      that.getInterface().equals(other.getInterface())
      && that.getType().equals(other.getType())
      && that.getRange().equals(other.getRange())
      && that.getVoid().equals(other.getVoid()));
  }
