...
public class Copying
{
    ...
    private static class _ShallowCopier extends AbstractTransformer<IClass> {
        ...
        public IClass transformBranch(
            ...
            return new Branch(that.getIdentifier(), that.getDescription());
        }
        ...
        public IClass transformContainer(
            ...
            return new Container(that.getNode(), that.getSomething());
        }
    }
    ...
    private static class _DeepCopier extends AbstractTransformer<IClass> {
        ...
        public IClass transformSomething (
            ...
            return new Something(
                deep(that.getSomeChoice()),
                deep(that.getSomethingWithoutChoice())
            );
        }
