...
public class TestCopying {
  private static class _DeepEqualiser extends AbstractTransformerWithContext<IClass, Boolean> {
    ...
    public Boolean transformSomething(ISomething that, IClass other) {
      ...
      return (
        that.getSomeBool().equals(casted.getSomeBool())
        && that.getSomeInt().equals(casted.getSomeInt())
        && that.getSomeFloat().equals(casted.getSomeFloat())
        && that.getSomeString().equals(casted.getSomeString())
        && Arrays.equals(
          that.getSomeBytes(),
          casted.getSomeBytes()));
    }
  ...
  private static Boolean SomethingShallowEquals(
    ...
    Something other) {
    return (
      that.getSomeBool().equals(other.getSomeBool())
      && that.getSomeInt().equals(other.getSomeInt())
      && that.getSomeFloat().equals(other.getSomeFloat())
      && that.getSomeString().equals(other.getSomeString())
