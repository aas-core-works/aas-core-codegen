                ...
                foreach (var keyValue in obj)
                {
                    switch (keyValue.Key)
                    {
                        case "interface":
                        {
                            ...
                            theInterface = DeserializeImplementation.StringFrom(
                                keyValue.Value,
                                out error);
                            if (error != null)
                            {
                            ...
                            if (theInterface == null)
                            {
                                throw new System.InvalidOperationException(
                                    "Unexpected theInterface null when error is also null");
                            }
                            break;
                        }
                        case "type":
                        ...
                        case "range":
                        {
                            ...
                            theRange = DeserializeImplementation.StringFrom(
                                keyValue.Value,
                                out error);
                            if (error != null)
                            {
                            ...
                            {
                                throw new System.InvalidOperationException(
                                    "Unexpected theRange null when error is also null");
                            }
                            break;
                        }
                        case "void":
                        {
                            ...
                            theVoid = DeserializeImplementation.StringFrom(
                                keyValue.Value,
                                out error);
                            if (error != null)
                            {
                            ...
                            {
                                throw new System.InvalidOperationException(
                                    "Unexpected theVoid null when error is also null");
                            }
                            break;
                        }
                        default:
