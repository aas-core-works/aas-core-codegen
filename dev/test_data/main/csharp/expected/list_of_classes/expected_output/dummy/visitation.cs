...
namespace dummy
{
    public static class Visitation
    {
        ...
        public class VisitorThrough : IVisitor
        {
            ...
            public virtual void VisitSomeItem(
                ISomeItem that
            )
            {
            ...
            public virtual void VisitAnotherItem(
                IAnotherItem that
            )
            {
                // Just descend through, do nothing with <c>that</c>
            ...
            public virtual void VisitSimple(
                ISimple that
            )
            {
                // Just descend through, do nothing with <c>that</c>
        ...
        public abstract class AbstractVisitor : IVisitor
        {
            ...
            public abstract void VisitSimple(
                ISimple that
            );
        ...
        public interface ITransformer<out T>
        {
            ...
            public T TransformSomeItem(
                ISomeItem that
            );
            public T TransformAnotherItem(
                IAnotherItem that
            );
            public T TransformSimple(
                ISimple that
            );
        ...
        public abstract class AbstractTransformer<T> : ITransformer<T>
        {
            ...
            public abstract T TransformSimple(
                ISimple that
            );
