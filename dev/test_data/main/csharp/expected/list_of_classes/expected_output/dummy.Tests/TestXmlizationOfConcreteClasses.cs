    ...
    public class TestXmlizationOfConcreteClasses
    {
        ...
        public void Test_SomeItem_ok()
        {
            ...
            foreach (var path in paths)
            {
                ...
                var instance = Aas.Xmlization.Deserialize.SomeItemFrom(
                    xmlReader);
        ...
        public void Test_SomeItem_deserialization_fail()
        {
            ...
            )
            {
                ...
                foreach (var path in paths)
                {
                    ...
                    try
                    {
                        _ = Aas.Xmlization.Deserialize.SomeItemFrom(
                            xmlReader);
                    }
        ...
        public void Test_AnotherItem_ok()
        {
            ...
            foreach (var path in paths)
            {
                ...
                var instance = Aas.Xmlization.Deserialize.AnotherItemFrom(
                    xmlReader);
        ...
        public void Test_AnotherItem_deserialization_fail()
        {
            ...
            )
            {
                ...
                foreach (var path in paths)
                {
                    ...
                    try
                    {
                        _ = Aas.Xmlization.Deserialize.AnotherItemFrom(
                            xmlReader);
                    }
                    catch (Aas.Xmlization.Exception observedException)
                    {
        ...
        public void Test_Simple_ok()
        {
            ...
            foreach (var path in paths)
            {
                ...
                var instance = Aas.Xmlization.Deserialize.SimpleFrom(
                    xmlReader);
        ...
        public void Test_Simple_deserialization_fail()
        {
            ...
            )
            {
                ...
                foreach (var path in paths)
                {
                    ...
                    try
                    {
                        _ = Aas.Xmlization.Deserialize.SimpleFrom(
                            xmlReader);
                    }
                    catch (Aas.Xmlization.Exception observedException)
                    {
