...
namespace dummy.Tests
{
    public class TestJsonizationOfConcreteClasses
    {
        ...
        [Test]
        public void Test_SomeItem_deserialization_from_non_object_fail()
        {
            ...
            try
            {
                var _ = Aas.Jsonization.Deserialize.SomeItemFrom(
                    node);
            }
        ...
        [Test]
        public void Test_SomeItem_deserialization_fail()
        {
            foreach (
                string causeDir in
        ...
        [Test]
        public void Test_SomeItem_verification_fail()
        {
            foreach (
                string causeDir in
                Directory.GetDirectories(
        ...
        [Test]
        public void Test_AnotherItem_ok()
        {
            var paths = Directory.GetFiles(
                Path.Combine(
                    Aas.Tests.Common.TestDataDir,
        ...
        [Test]
        public void Test_AnotherItem_deserialization_from_non_object_fail()
        {
            var node = Nodes.JsonValue.Create("INVALID")
                ?? throw new System.InvalidOperationException(
                    "Unexpected failure of the node creation");
            ...
            try
            {
                var _ = Aas.Jsonization.Deserialize.AnotherItemFrom(
                    node);
            }
            catch (Aas.Jsonization.Exception observedException)
            {
        ...
        [Test]
        public void Test_AnotherItem_deserialization_fail()
        {
            foreach (
                string causeDir in
                Directory.GetDirectories(
        ...
        [Test]
        public void Test_AnotherItem_verification_fail()
        {
            foreach (
                string causeDir in
                Directory.GetDirectories(
        ...
        [Test]
        public void Test_Simple_deserialization_from_non_object_fail()
        {
            var node = Nodes.JsonValue.Create("INVALID")
                ?? throw new System.InvalidOperationException(
                    "Unexpected failure of the node creation");
            ...
            try
            {
                var _ = Aas.Jsonization.Deserialize.SimpleFrom(
                    node);
            }
            catch (Aas.Jsonization.Exception observedException)
            {
        ...
        [Test]
        public void Test_Simple_deserialization_fail()
        {
            foreach (
                string causeDir in
                Directory.GetDirectories(
        ...
        [Test]
        public void Test_Simple_verification_fail()
        {
            foreach (
                string causeDir in
                Directory.GetDirectories(
