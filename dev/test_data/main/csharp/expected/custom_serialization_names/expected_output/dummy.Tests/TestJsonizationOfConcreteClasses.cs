...
namespace dummy.Tests
{
    public class TestJsonizationOfConcreteClasses
    {
        ...
        [Test]
        public void Test_QueryCondition_ok()
        {
        ...
        [Test]
        public void Test_QueryCondition_deserialization_from_non_object_fail()
        {
            ...
            try
            {
                var _ = Aas.Jsonization.Deserialize.QueryConditionFrom(
                    node);
            }
        ...
        [Test]
        public void Test_QueryCondition_deserialization_fail()
        {
            foreach (
                string causeDir in
        ...
        [Test]
        public void Test_QueryCondition_verification_fail()
        {
            foreach (
                string causeDir in
                Directory.GetDirectories(
