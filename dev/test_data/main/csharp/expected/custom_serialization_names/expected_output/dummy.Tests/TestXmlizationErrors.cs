...
namespace dummy.Tests
{
    public class TestXmlizationErrors
    {
        ...
        public void Test_error_on_unexpected_declaration()
        {
            ...
            if (!text.StartsWith("<queryCondition "))
            {
                throw new System.InvalidOperationException(
                    "We expect our test example in XML to start with '<queryCondition ', "
            ...
            try
            {
                Aas.Xmlization.Deserialize.QueryConditionFrom(
                    xmlReader);
            }
            ...
            Assert.AreEqual(
                ...
                "class QueryCondition, as we expect the reader to be set at content " +
