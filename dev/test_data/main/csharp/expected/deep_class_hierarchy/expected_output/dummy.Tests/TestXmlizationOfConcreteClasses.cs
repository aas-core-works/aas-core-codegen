    ...
    public class TestXmlizationOfConcreteClasses
    {
        ...
        public void Test_Branch_ok()
        {
            ...
            foreach (var path in paths)
            {
                ...
                var instance = Aas.Xmlization.Deserialize.BranchFrom(
                    xmlReader);
        ...
        public void Test_Branch_deserialization_fail()
        {
            ...
            )
            {
                ...
                foreach (var path in paths)
                {
                    ...
                    try
                    {
                        _ = Aas.Xmlization.Deserialize.BranchFrom(
                            xmlReader);
                    }
        ...
        public void Test_Blossom_ok()
        {
            ...
            foreach (var path in paths)
            {
                ...
                var instance = Aas.Xmlization.Deserialize.BlossomFrom(
                    xmlReader);
        ...
        public void Test_Blossom_deserialization_fail()
        {
            ...
            )
            {
                ...
                foreach (var path in paths)
                {
                    ...
                    try
                    {
                        _ = Aas.Xmlization.Deserialize.BlossomFrom(
                            xmlReader);
                    }
                    catch (Aas.Xmlization.Exception observedException)
                    {
