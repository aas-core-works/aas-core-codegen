...
namespace dummy.Tests
{
    public class TestJsonizationOfConcreteClasses
    {
        ...
        [Test]
        public void Test_Branch_deserialization_from_non_object_fail()
        {
        ...
        [Test]
        public void Test_Branch_deserialization_fail()
        {
            foreach (
                string causeDir in
        ...
        [Test]
        public void Test_Branch_verification_fail()
        {
            foreach (
                string causeDir in
                Directory.GetDirectories(
        ...
        [Test]
        public void Test_Blossom_deserialization_from_non_object_fail()
        {
            var node = Nodes.JsonValue.Create("INVALID")
                ?? throw new System.InvalidOperationException(
                    "Unexpected failure of the node creation");
        ...
        [Test]
        public void Test_Blossom_deserialization_fail()
        {
            foreach (
                string causeDir in
                Directory.GetDirectories(
