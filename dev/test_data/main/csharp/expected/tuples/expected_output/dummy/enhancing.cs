...
namespace dummy
{
    ...
    public static class Enhancing
    {
            ...
            where TEnhancement : class
        {
            ...
            public (string, long) Pair
            {
                get => _instance.Pair;
                set => _instance.Pair = value;
            }

            public (IAbstractItem, IAbstractItem) Items
            {
                get => _instance.Items;
                set => _instance.Items = value;
            }

            public (long, ISomeItem, IAbstractItem, ISomeItem, long, Result) Tricky
            {
                get => _instance.Tricky;
            ...
            where TEnhancement : class
        {
            ...
            )
            {
                ...
                var castedItems0 = (
                    transformedItems0 as Aas.IAbstractItem
                ...
                var castedItems1 = (
                    transformedItems1 as Aas.IAbstractItem
                ) ?? throw new System.InvalidOperationException(
                    "Expected the transformed value to be a IAbstractItem, " +
                ...
                var castedTricky1 = (
                    transformedTricky1 as Aas.ISomeItem
                ) ?? throw new System.InvalidOperationException(
                ...
                var castedTricky2 = (
                    transformedTricky2 as Aas.IAbstractItem
                ) ?? throw new System.InvalidOperationException(
                    "Expected the transformed value to be a IAbstractItem, " +
                ...
                var castedTricky3 = (
                    transformedTricky3 as Aas.ISomeItem
                ) ?? throw new System.InvalidOperationException(
                    "Expected the transformed value to be a ISomeItem, " +
