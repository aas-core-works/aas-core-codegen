    ...
    def test_abstract_item(self) -> None:
        for xml_class_name_of_descendant in [
            ...
            for path in sorted(
                ...
                got_from_iterparse = aas_xmlization.abstract_item_from_iterparse(iterator)
                ...
                # region From stream
                got_from_stream = aas_xmlization.abstract_item_from_stream(io.StringIO(text))
                ...
                with tempfile.TemporaryDirectory() as tmp_dir:
                    ...
                    got_from_file = aas_xmlization.abstract_item_from_file(path)
                ...
                # region From string
                got_from_str = aas_xmlization.abstract_item_from_str(text)
