...
class QueryCondition(Class):
    ...
    def accept(self, visitor: "AbstractVisitor") -> None:
        """Dispatch the :paramref:`visitor` on this instance."""
        visitor.visit_query_condition(self)
    ...
    def accept_with_context(
        ...
        visitor.visit_query_condition_with_context(self, context)
    ...
    def transform(
        ...
        """Dispatch the :paramref:`transformer` on this instance."""
        return transformer.transform_query_condition(self)
    ...
    def transform_with_context(
        ...
        """
        return transformer.transform_query_condition_with_context(
            self, context)
...
class AbstractVisitorWithContext(Generic[ContextT]):
    ...
    @abc.abstractmethod
    def visit_query_condition_with_context(
            self,
            that: QueryCondition,
            context: ContextT
    ) -> None:
...
class AbstractTransformerWithContext(
    ...
    @abc.abstractmethod
    def transform_query_condition_with_context(
            self,
            that: QueryCondition,
            context: ContextT
    ) -> T:
