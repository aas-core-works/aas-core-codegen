...
class _ReaderAndSetterForSomething:
    ...
    def __init__(self) -> None:
        ...
        self.void: Optional[str] = None

    def read_and_set_interface(
        self,
        element: Element,
        iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        ...
        :py:attr:`.types.Something.interface` and set it.
        """
        self.interface = _read_str_from_element_text(
            element,
            iterator
        )
    ...
    def read_and_set_type(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Something.type` and set it.
        """
    ...
    def read_and_set_range(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Something.range` and set it.
        """
        self.range = _read_str_from_element_text(
            element,
            iterator
        )

    def read_and_set_void(
        self,
        element: Element,
        iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.Something.void` and set it.
        """
        self.void = _read_str_from_element_text(
            element,
            iterator
        )
...
def _read_something_as_sequence(
    ...
    if reader_and_setter.interface is None:
        raise DeserializationException(
    ...
    if reader_and_setter.range is None:
        raise DeserializationException(
            "The required property 'range' is missing"
        )

    if reader_and_setter.void is None:
        raise DeserializationException(
            "The required property 'void' is missing"
        )

    return aas_types.Something(
        reader_and_setter.interface,
        reader_and_setter.type,
        reader_and_setter.range,
        reader_and_setter.void
    )
...
_READ_AND_SET_DISPATCH_FOR_SOMETHING: Mapping[
    ...
    'interface':
        _ReaderAndSetterForSomething.read_and_set_interface,
    'type':
        _ReaderAndSetterForSomething.read_and_set_type,
    'range':
        _ReaderAndSetterForSomething.read_and_set_range,
    'void':
        _ReaderAndSetterForSomething.read_and_set_void,
}
