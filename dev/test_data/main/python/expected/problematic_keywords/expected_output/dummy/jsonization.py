...
class _SetterForSomething:
    ...
    def set_interface_from_jsonable(
            self,
            jsonable: Jsonable
    ) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~interface`.

        :param jsonable: input to be parsed
        """
        self.interface = _str_from_jsonable(
            jsonable
        )
    ...
    def set_range_from_jsonable(
            self,
            jsonable: Jsonable
    ) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~range`.

        :param jsonable: input to be parsed
        """
        self.range = _str_from_jsonable(
            jsonable
        )

    def set_void_from_jsonable(
            self,
            jsonable: Jsonable
    ) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~void`.

        :param jsonable: input to be parsed
        """
        self.void = _str_from_jsonable(
            jsonable
        )
...
def something_from_jsonable(
    ...
    if setter.range is None:
        raise DeserializationException(
            "The required property 'range' is missing"
        )

    if setter.void is None:
        raise DeserializationException(
...
_SETTER_MAP_FOR_SOMETHING: Mapping[
    ...
    'interface':
        _SetterForSomething.set_interface_from_jsonable,
    'type':
        _SetterForSomething.set_type_from_jsonable,
    'range':
        _SetterForSomething.set_range_from_jsonable,
    'void':
        _SetterForSomething.set_void_from_jsonable,
    'modelType':
