...
class _ReaderAndSetterForSomething:
    ...
    def __init__(self) -> None:
        ...
        self.some_result: Optional[aas_types.Result] = None

    def read_and_set_some_result(
        self,
        element: Element,
        iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        ...
        :py:attr:`.types.Something.some_result` and set it.
        """
        self.some_result = _read_result_from_element_text(
            element,
            iterator
        )
...
def _read_something_as_sequence(
    ...
    if reader_and_setter.some_result is None:
        raise DeserializationException(
            "The required property 'someResult' is missing"
        )

    return aas_types.Something(
        reader_and_setter.some_result
    )
...
_READ_AND_SET_DISPATCH_FOR_SOMETHING: Mapping[
    ...
    'someResult':
        _ReaderAndSetterForSomething.read_and_set_some_result,
}
