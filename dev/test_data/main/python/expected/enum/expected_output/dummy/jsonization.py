...
class _SetterForSomething:
    ...
    def set_some_result_from_jsonable(
            self,
            jsonable: Jsonable
    ) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~some_result`.

        :param jsonable: input to be parsed
        """
        self.some_result = result_from_jsonable(
            jsonable
        )
...
_SETTER_MAP_FOR_SOMETHING: Mapping[
    ...
    'someResult':
        _SetterForSomething.set_some_result_from_jsonable,
    'modelType':
...
class _Serializer(
    ...
    def transform_something(
        ...
        jsonable['someResult'] = that.some_result.value
