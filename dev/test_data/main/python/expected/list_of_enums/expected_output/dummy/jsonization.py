...
class _SetterForSomething:
    ...
    def set_some_results_from_jsonable(
            self,
            jsonable: Jsonable
    ) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~some_results`.
...
def something_from_jsonable(
    ...
    if setter.some_results is None:
        raise DeserializationException(
...
_SETTER_MAP_FOR_SOMETHING: Mapping[
    ...
    'someResults':
        _SetterForSomething.set_some_results_from_jsonable,
    'modelType':
...
class _Serializer(
    ...
    def transform_something(
        ...
        jsonable['someResults'] = [
            item.value
            for item in that.some_results
        ]
