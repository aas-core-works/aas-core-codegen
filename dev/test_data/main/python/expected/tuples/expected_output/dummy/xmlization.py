...
class _ReaderAndSetterForSomething:
    ...
    def read_and_set_items(
        ...
        try:
            item_0 = _read_abstract_item_as_element(
                next_element,
                iterator
            )
        except DeserializationException as exception:
        ...
        try:
            item_1 = _read_abstract_item_as_element(
                next_element,
                iterator
            )
        except DeserializationException as exception:
    ...
    def read_and_set_tricky(
        ...
        try:
            item_1 = _read_some_item_as_element(
                next_element,
                iterator
            )
        except DeserializationException as exception:
        ...
        try:
            item_2 = _read_abstract_item_as_element(
                next_element,
                iterator
            )
        except DeserializationException as exception:
        ...
        try:
            item_3 = _read_some_item_as_element(
                next_element,
                iterator
            )
        except DeserializationException as exception:
