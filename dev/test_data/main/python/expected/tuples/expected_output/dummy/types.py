...
class SomeItem(AbstractItem):
    ...
    def accept_with_context(
        ...
        visitor.visit_some_item_with_context(self, context)
    ...
    def transform(
        ...
        """Dispatch the :paramref:`transformer` on this instance."""
        return transformer.transform_some_item(self)
    ...
    def transform_with_context(
        ...
        """
        return transformer.transform_some_item_with_context(
            self, context)
...
class AnotherItem(AbstractItem):
    ...
    def accept(self, visitor: "AbstractVisitor") -> None:
        """Dispatch the :paramref:`visitor` on this instance."""
        visitor.visit_another_item(self)
    ...
    def accept_with_context(
        ...
        """Dispatch the :paramref:`visitor` on this instance in :paramref:`context`."""
        visitor.visit_another_item_with_context(self, context)
    ...
    def transform(
        ...
        """Dispatch the :paramref:`transformer` on this instance."""
        return transformer.transform_another_item(self)
    ...
    def transform_with_context(
        ...
        Dispatch the :paramref:`transformer` on this instance in :paramref:`context`.
        """
        return transformer.transform_another_item_with_context(
            self, context)
...
class Something(Class):
    ...
    items: Tuple['AbstractItem', 'AbstractItem']

    tricky: Tuple[int, 'SomeItem', 'AbstractItem', 'SomeItem', int, 'Result']
...
class AbstractVisitorWithContext(Generic[ContextT]):
    ...
    @abc.abstractmethod
    def visit_some_item_with_context(
            self,
            that: SomeItem,
            context: ContextT
    ) -> None:
    ...
    @abc.abstractmethod
    def visit_another_item_with_context(
            self,
            that: AnotherItem,
            context: ContextT
    ) -> None:
...
class AbstractTransformerWithContext(
    ...
    @abc.abstractmethod
    def transform_some_item_with_context(
            self,
            that: SomeItem,
            context: ContextT
    ) -> T:
