...
func readSomethingAsSequence(
	...
	for {
		...
		switch local {
		case "someBools":
			theSomeBools, current, valueErr = readListOfScalars(
				decoder,
				current,
				readTextAsBoolean,
			)
		...
		case "someInts":
			theSomeInts, current, valueErr = readListOfScalars(
				decoder,
				current,
				readTextAsLong,
			)
		...
		case "someFloats":
			theSomeFloats, current, valueErr = readListOfScalars(
				decoder,
				current,
				readTextAsDouble,
			)
		...
		case "someStrings":
			theSomeStrings, current, valueErr = readListOfScalars(
				decoder,
				current,
				readText,
			)
		...
		case "someBytes":
			theSomeBytes, current, valueErr = readListOfScalars(
				decoder,
				current,
				readTextAsBase64EncodedBytes,
			)
			foundSomeBytes = true
