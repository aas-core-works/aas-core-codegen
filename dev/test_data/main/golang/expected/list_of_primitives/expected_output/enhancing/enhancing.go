...
func (es *enhancedSomething[E]) SomeBools(
) []bool {
	return es.instance.SomeBools()
}

func (es *enhancedSomething[E]) SetSomeBools(
	value []bool,
) {
	es.instance.SetSomeBools(value)
}

func (es *enhancedSomething[E]) SomeInts(
) []int64 {
	return es.instance.SomeInts()
}

func (es *enhancedSomething[E]) SetSomeInts(
	value []int64,
) {
	es.instance.SetSomeInts(value)
}

func (es *enhancedSomething[E]) SomeFloats(
) []float64 {
	return es.instance.SomeFloats()
}

func (es *enhancedSomething[E]) SetSomeFloats(
	value []float64,
) {
	es.instance.SetSomeFloats(value)
}

func (es *enhancedSomething[E]) SomeStrings(
) []string {
	return es.instance.SomeStrings()
}

func (es *enhancedSomething[E]) SetSomeStrings(
	value []string,
) {
	es.instance.SetSomeStrings(value)
}
