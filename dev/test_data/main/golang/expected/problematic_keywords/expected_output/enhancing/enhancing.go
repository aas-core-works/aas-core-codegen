...
func (es *enhancedSomething[E]) Interface(
) string {
	return es.instance.Interface()
}

func (es *enhancedSomething[E]) SetInterface(
	value string,
) {
	es.instance.SetInterface(value)
}

func (es *enhancedSomething[E]) Type(
) string {
	return es.instance.Type()
}

func (es *enhancedSomething[E]) SetType(
	value string,
) {
	es.instance.SetType(value)
}

func (es *enhancedSomething[E]) Range(
) string {
	return es.instance.Range()
}

func (es *enhancedSomething[E]) SetRange(
	value string,
) {
	es.instance.SetRange(value)
}

func (es *enhancedSomething[E]) Void(
) string {
	return es.instance.Void()
}

func (es *enhancedSomething[E]) SetVoid(
	value string,
) {
	es.instance.SetVoid(value)
}
