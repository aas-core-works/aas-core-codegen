...
func TestBlossomOK(t *testing.T) {
	pths := aastesting.FindFilesBySuffixRecursively(
		filepath.Join(
			aastesting.TestDataDir,
			"Json",
...
func TestBlossomFail(t *testing.T) {
	pattern := filepath.Join(
		aastesting.TestDataDir,
		"Json",
		"Unexpected",
...
func TestContainerFail(t *testing.T) {
	pattern := filepath.Join(
		aastesting.TestDataDir,
		"Json",
		"Unexpected",
