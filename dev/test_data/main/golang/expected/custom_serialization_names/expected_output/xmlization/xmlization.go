...
func writeQueryConditionAsSequence(
	encoder *xml.Encoder,
...
// Serialize the instance of [aastypes.IQueryCondition]
...
func writeQueryCondition(
	...
	err = writeQueryConditionAsSequence(
		encoder,
		that,
	)
	if err != nil {
