...
func readSomethingAsSequence(
	...
	for {
		...
		switch local {
		case "pair":
			var itemPair0 string
			var itemPair1 int64

			itemPair0, current, valueErr = readScalarWithName(
				decoder,
				current,
				"v1",
				readText,
			...
			if valueErr == nil {
				itemPair1, current, valueErr = readScalarWithName(
					decoder,
					current,
					"v2",
					readTextAsLong,
		...
		case "items":
			var itemItems0 aastypes.IAbstractItem
			var itemItems1 aastypes.IAbstractItem

			current, valueErr = skipEmptyTextWhitespaceAndComments(decoder, current)
			if valueErr == nil {
				itemItems0, valueErr = readAbstractItemWithLookahead(
					decoder,
					current,
				)
				if valueErr == nil {
			...
			if valueErr == nil {
				current, valueErr = skipEmptyTextWhitespaceAndComments(decoder, current)
				if valueErr == nil {
					itemItems1, valueErr = readAbstractItemWithLookahead(
						decoder,
						current,
					)
					if valueErr == nil {
		...
		case "tricky":
			var itemTricky0 int64
			var itemTricky1 aastypes.ISomeItem
			var itemTricky2 aastypes.IAbstractItem
			var itemTricky3 aastypes.ISomeItem
			var itemTricky4 int64
			var itemTricky5 aastypes.Result

			itemTricky0, current, valueErr = readScalarWithName(
				decoder,
				current,
				"v1",
				readTextAsLong,
			...
			if valueErr == nil {
				current, valueErr = skipEmptyTextWhitespaceAndComments(decoder, current)
				if valueErr == nil {
					itemTricky1, valueErr = readSomeItemWithLookahead(
						decoder,
						current,
					)
					if valueErr == nil {
				...
				if valueErr == nil {
					current, valueErr = skipEmptyTextWhitespaceAndComments(decoder, current)
					if valueErr == nil {
						itemTricky2, valueErr = readAbstractItemWithLookahead(
							decoder,
							current,
						)
						if valueErr == nil {
					...
					if valueErr == nil {
						current, valueErr = skipEmptyTextWhitespaceAndComments(decoder, current)
						if valueErr == nil {
							itemTricky3, valueErr = readSomeItemWithLookahead(
								decoder,
								current,
							)
							if valueErr == nil {
						...
						if valueErr == nil {
							itemTricky4, current, valueErr = readScalarWithName(
								decoder,
								current,
								"v5",
								readTextAsLong,
							...
							if valueErr == nil {
								itemTricky5, current, valueErr = readScalarWithName(
									decoder,
									current,
									"v6",
									readTextAsResult,
