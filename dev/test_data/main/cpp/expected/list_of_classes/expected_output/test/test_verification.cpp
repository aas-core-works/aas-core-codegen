...
TEST_CASE("Test verification of a valid SomeItem") {
...
TEST_CASE("Test verification of invalid cases for SomeItem") {
  for (
...
TEST_CASE("Test verification of a valid AnotherItem") {
  const std::deque<std::filesystem::path> paths(
    test::common::FindFilesBySuffixRecursively(
      DetermineXmlDir()
        / "Expected"
...
TEST_CASE("Test verification of invalid cases for AnotherItem") {
  for (
    const std::filesystem::path& causeDir
    : test::common::ListSubdirectories(
      DetermineXmlDir()
...
TEST_CASE("Test verification of a valid Simple") {
  const std::deque<std::filesystem::path> paths(
    test::common::FindFilesBySuffixRecursively(
      DetermineXmlDir()
        / "Expected"
...
TEST_CASE("Test verification of invalid cases for Simple") {
  for (
    const std::filesystem::path& causeDir
    : test::common::ListSubdirectories(
      DetermineXmlDir()
