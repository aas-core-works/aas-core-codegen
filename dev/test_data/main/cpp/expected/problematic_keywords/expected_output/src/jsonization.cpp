...
> DeserializeSomething(
  ...
  // endregion De-serialize interface
  ...
  // endregion De-serialize range

  // region De-serialize void
...
> SerializeSomething(
  ...
  result["interface"] = SerializeWstring(
    that.interface()
  );
  ...
  result["range"] = SerializeWstring(
    that.range()
  );

  result["void"] = SerializeWstring(
    that.voiD()
  );
