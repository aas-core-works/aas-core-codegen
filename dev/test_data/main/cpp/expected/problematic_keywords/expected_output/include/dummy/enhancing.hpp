...
class EnhancedSomething
 ...
 public:
  ...
  const std::wstring& interface() const override {
    return instance_->interface();
  }

  std::wstring& mutable_interface() override {
    return instance_->mutable_interface();
  }

  void set_interface(
    std::wstring value
  ) override {
    instance_->set_interface(value);
  }
  ...
  const std::wstring& range() const override {
    return instance_->range();
  }

  std::wstring& mutable_range() override {
    return instance_->mutable_range();
  }

  void set_range(
    std::wstring value
  ) override {
    instance_->set_range(value);
  }

  const std::wstring& voiD() const override {
    return instance_->voiD();
  }

  std::wstring& mutable_void() override {
    return instance_->mutable_void();
  }

  void set_void(
    std::wstring value
  ) override {
    instance_->set_void(value);
  }
