...
TEST_CASE("Test the round-trip of an expected QueryCondition") {
...
TEST_CASE("Test the de-serialization failure on an unexpected QueryCondition") {
  for (
