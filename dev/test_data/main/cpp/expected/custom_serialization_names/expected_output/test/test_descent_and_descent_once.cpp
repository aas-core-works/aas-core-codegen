...
TEST_CASE("Test Descent over an QueryCondition") {
...
TEST_CASE("Test DescentOnce over an QueryCondition") {
  const std::shared_ptr<
    aas::types::IQueryCondition
  > instance(
    test::common::examples::LoadMaxQueryCondition()
  );

  const std::filesystem::path trace_path(
    DetermineDescentOnceDir()
      / "MaxQueryCondition.trace"
  );
