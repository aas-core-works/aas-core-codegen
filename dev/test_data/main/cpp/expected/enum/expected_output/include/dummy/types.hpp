...
class ISomething
 ...
 public:
  virtual Result some_result() const = 0;

  virtual Result& mutable_some_result() = 0;

  virtual void set_some_result(
    Result value
  ) = 0;
...
class Something
 ...
 public:
  ...
  // region Get and set some_result_

  Result some_result() const override;

  Result& mutable_some_result() override;
