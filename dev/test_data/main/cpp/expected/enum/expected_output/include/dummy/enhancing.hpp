...
class EnhancedSomething
 ...
 public:
  ...
  types::Result some_result() const override {
    return instance_->some_result();
  }

  types::Result& mutable_some_result() override {
    return instance_->mutable_some_result();
  }

  void set_some_result(
    types::Result value
  ) override {
    instance_->set_some_result(value);
  }
