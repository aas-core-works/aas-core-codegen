#ifndef DUMMY_ITERATION_GUARD_
#define DUMMY_ITERATION_GUARD_
...
/**
 * \brief Give a container for all the literals of types::Result.
 *
 * This container is practical when you want to show the literals in a GUI or a CLI.
 */
extern const std::vector<types::Result> kOverResult;
