...
bool DetermineRecordMode() {
  const char* variable_name = "AAS_CORE_AAS_3_0_TEST_RECORD_MODE";
...
std::filesystem::path DetermineTestDataDir() {
  const char* variable_name = "AAS_CORE_AAS_3_0_TEST_DATA_DIR";
  ...
  if (record_mode) {
    ...
    INFO(
      aas::common::Concat(
        ...
        "please set the environment variable AAS_CORE_AAS_3_0_TEST_RECORD_MODE "
        "to 'ON'"
      )
    )
