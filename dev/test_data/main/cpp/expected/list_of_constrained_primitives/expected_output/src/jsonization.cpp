...
> DeserializeSomething(
  ...
  if (!json.contains("someNames")) {
    ...
    >(
      common::nullopt,
      common::make_optional<DeserializationError>(
        L"The required property someNames is missing"
      )
    );
  }
  ...
  common::optional<std::vector<std::wstring> > the_some_names;

  // endregion Initialization

  // region De-serialize someNames
  ...
  // endregion De-serialize someNames
...
> SerializeSomething(
  ...
  result["someNames"] = SerializeListWithInfallible(
    that.some_names(),
    SerializeWstring
  );
