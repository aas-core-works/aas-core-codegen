    ...
    switch (property) {
      case properties::OfSomething::kPair: {
        ...
        do {
          ...
          auto deserialize_pair_item_0 = [](ReaderMergingText& a_reader) {
          ...
          std::tie(
            the_pair_item_0,
            error
          ) = deserialize_pair_item_0(reader);
          if (error.has_value()) {
            error->path.segments.emplace_front(
          ...
          auto deserialize_pair_item_1 = [](ReaderMergingText& a_reader) {
              return DeserializeValueFromVElement<
                int64_t
              >(
                a_reader,
          ...
          std::tie(
            the_pair_item_1,
            error
          ) = deserialize_pair_item_1(reader);
          if (error.has_value()) {
            error->path.segments.emplace_front(
              common::make_unique<IndexSegment>(
                1
      ...
      case properties::OfSomething::kItems: {
        ...
        do {
          ...
          auto deserialize_items_item_0 = AbstractItemFromElement;
          std::tie(
            the_items_item_0,
            error
          ) = deserialize_items_item_0(reader);
          if (error.has_value()) {
            error->path.segments.emplace_front(
              common::make_unique<IndexSegment>(
                0
          ...
          auto deserialize_items_item_1 = AbstractItemFromElement;
          std::tie(
            the_items_item_1,
            error
          ) = deserialize_items_item_1(reader);
          if (error.has_value()) {
            error->path.segments.emplace_front(
              common::make_unique<IndexSegment>(
                1
      ...
      case properties::OfSomething::kTricky: {
        ...
        do {
          ...
          auto deserialize_tricky_item_0 = [](ReaderMergingText& a_reader) {
              return DeserializeValueFromVElement<
                int64_t
              >(
                a_reader,
          ...
          std::tie(
            the_tricky_item_0,
            error
          ) = deserialize_tricky_item_0(reader);
          if (error.has_value()) {
            error->path.segments.emplace_front(
              common::make_unique<IndexSegment>(
                0
          ...
          auto deserialize_tricky_item_1 = SomeItemFromElement;
          std::tie(
            the_tricky_item_1,
            error
          ) = deserialize_tricky_item_1(reader);
          if (error.has_value()) {
            error->path.segments.emplace_front(
              common::make_unique<IndexSegment>(
                1
          ...
          auto deserialize_tricky_item_2 = AbstractItemFromElement;
          std::tie(
            the_tricky_item_2,
            error
          ) = deserialize_tricky_item_2(reader);
          if (error.has_value()) {
            error->path.segments.emplace_front(
              common::make_unique<IndexSegment>(
                2
          ...
          auto deserialize_tricky_item_3 = SomeItemFromElement;
          std::tie(
            the_tricky_item_3,
            error
          ) = deserialize_tricky_item_3(reader);
          if (error.has_value()) {
            error->path.segments.emplace_front(
              common::make_unique<IndexSegment>(
                3
          ...
          auto deserialize_tricky_item_4 = [](ReaderMergingText& a_reader) {
              return DeserializeValueFromVElement<
                int64_t
              >(
                a_reader,
          ...
          std::tie(
            the_tricky_item_4,
            error
          ) = deserialize_tricky_item_4(reader);
          if (error.has_value()) {
            error->path.segments.emplace_front(
              common::make_unique<IndexSegment>(
                4
          ...
          auto deserialize_tricky_item_5 = [](ReaderMergingText& a_reader) {
              return DeserializeValueFromVElement<
                types::Result
              >(
                a_reader,
          ...
          std::tie(
            the_tricky_item_5,
            error
          ) = deserialize_tricky_item_5(reader);
          if (error.has_value()) {
            error->path.segments.emplace_front(
              common::make_unique<IndexSegment>(
                5
 ...
 * \return error, if any
 */
common::optional<SerializationError> SerializeSomeItemAsSequence(
 ...
 */
common::optional<SerializationError> SerializeSomeItemAsElement(
  const types::ISomeItem& that,
  SelfClosingWriter& writer
);
 ...
 * \return error, if any
 */
common::optional<SerializationError> SerializeAnotherItemAsSequence(
...
common::optional<SerializationError> SerializeAbstractItemAsElement(
  ...
  switch (that.model_type()) {
    case types::ModelType::kAnotherItem:
      return SerializeAnotherItemAsElement(
        dynamic_cast<
          const types::IAnotherItem&
        >(that),
        writer
      );
    case types::ModelType::kSomeItem:
      return SerializeSomeItemAsElement(
        dynamic_cast<
          const types::ISomeItem&
        >(that),
        writer
      );
    default:
...
common::optional<SerializationError> SerializeSomeItemAsElement(
  ...
  error = SerializeSomeItemAsSequence(
    that,
    writer
  );
  if (error.has_value()) {
...
common::optional<SerializationError> SerializeAnotherItemAsElement(
  ...
  error = SerializeAnotherItemAsSequence(
    that,
    writer
  );
  if (error.has_value()) {
...
common::optional<SerializationError> SerializeSomethingAsSequence(
  ...
  do {
    error = SerializeAbstractItemPtrAsElement(
  ...
  do {
    ...
    error = SerializeSomeItemPtrAsElement(
