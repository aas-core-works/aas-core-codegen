...
std::wstring PropertyToWstring(
  ...
  switch (property) {
    ...
    case Property::kDetails:
      return L"details";
    case Property::kIdentifier:
      return L"identifier";
    case Property::kNode:
      return L"node";
    case Property::kSomeChoice:
      return L"some_choice";
    case Property::kSomething:
      return L"something";
    case Property::kSomethingWithoutChoice:
      return L"something_without_choice";
...
/**
 * This iterator is always done as IBranch
 * references no other instances.
 */
class IteratorOverBranch : public impl::IIterator {
 public:
  IteratorOverBranch(
  ...
  const std::shared_ptr<types::IClass>& Get() const override {
    throw std::logic_error(
      "You want to get from an IteratorOverBranch, "
      "but the iterator is always done as "
      "IBranch references "
      "no other instances."
    );
  ...
  std::unique_ptr<impl::IIterator> Clone() const override {
    return common::make_unique<IteratorOverBranch>(*this);
  }

  void PrependToPath(Path*) const override {
    throw std::logic_error(
      "You want to prepend to path from an IteratorOverBranch, "
      "but the iterator is always done as "
      "IBranch references "
      "no other instances."
    );
  ...
  ~IteratorOverBranch() override = default;
};  // class IteratorOverBranch

/**
 * This iterator is always done as ILeaf
 * references no other instances.
 */
class IteratorOverLeaf : public impl::IIterator {
 public:
  IteratorOverLeaf(
    const std::shared_ptr<types::IClass>&
  ) {
  ...
  const std::shared_ptr<types::IClass>& Get() const override {
    throw std::logic_error(
      "You want to get from an IteratorOverLeaf, "
      "but the iterator is always done as "
      "ILeaf references "
      "no other instances."
    );
  ...
  std::unique_ptr<impl::IIterator> Clone() const override {
    return common::make_unique<IteratorOverLeaf>(*this);
  }

  void PrependToPath(Path*) const override {
    throw std::logic_error(
      "You want to prepend to path from an IteratorOverLeaf, "
      "but the iterator is always done as "
      "ILeaf references "
      "no other instances."
    );
  ...
  ~IteratorOverLeaf() override = default;
};  // class IteratorOverLeaf

/**
 * This iterator is always done as IBlossom
 * references no other instances.
 */
class IteratorOverBlossom : public impl::IIterator {
 public:
  IteratorOverBlossom(
    const std::shared_ptr<types::IClass>&
  ) {
  ...
  const std::shared_ptr<types::IClass>& Get() const override {
    throw std::logic_error(
      "You want to get from an IteratorOverBlossom, "
      "but the iterator is always done as "
      "IBlossom references "
      "no other instances."
    );
  ...
  std::unique_ptr<impl::IIterator> Clone() const override {
    return common::make_unique<IteratorOverBlossom>(*this);
  }

  void PrependToPath(Path*) const override {
    throw std::logic_error(
      "You want to prepend to path from an IteratorOverBlossom, "
      "but the iterator is always done as "
      "IBlossom references "
      "no other instances."
    );
  ...
  ~IteratorOverBlossom() override = default;
};  // class IteratorOverBlossom
  ...
  while (true) {
    switch (state_) {
      case 0: {
        ...
        property_ = Property::kSomeChoice;
        item_ = std::move(
      ...
      case 1: {
        property_ = Property::kSomethingWithoutChoice;
        item_ = std::move(
          std::static_pointer_cast<types::IClass>(
            casted_->something_without_choice()
          )
        );
        ++index_;
...
// region Non-recursive iteration over IContainer

/**
 * Iterate non-recursively over the instances referenced from an instance.
 */
class IteratorOverContainer : public impl::IIterator {
 public:
  IteratorOverContainer(
    const std::shared_ptr<types::IClass>& instance
  );
  void Start() override;
  void Next() override;
...
void IteratorOverContainer::Start() {
  state_ = 0;
  Execute();
}

void IteratorOverContainer::Next() {
  #ifdef DEBUG
  if (Done()) {
    throw std::logic_error(
      "You want to move IteratorOverContainer, "
      "but it was done."
    );
  }
  #endif
...
bool IteratorOverContainer::Done() const {
  return done_;
}

const std::shared_ptr<types::IClass>& IteratorOverContainer::Get() const {
  #ifdef DEBUG
  if (Done()) {
    throw std::logic_error(
      "You want to get from IteratorOverContainer, "
      "but the iterator was done."
    );
  }
  #endif
...
long IteratorOverContainer::Index() const {
  #ifdef DEBUG
  if (Done() && index_ != -1) {
    throw std::logic_error(
      common::Concat(
        "Expected index to be -1 "
        "from a done IteratorOverContainer, "
        "but got: ",
        std::to_string(index_)
      )
    );
...
void IteratorOverContainer::PrependToPath(
  Path* path
) const {
  #ifdef DEBUG
  if (Done()) {
    throw std::logic_error(
      "You want to prepend to path from IteratorOverContainer, "
      "but the iterator was done."
    );
  }
...
std::unique_ptr<impl::IIterator> IteratorOverContainer::Clone() const {
  return common::make_unique<IteratorOverContainer>(*this);
}

void IteratorOverContainer::Execute() {
  while (true) {
    switch (state_) {
      case 0: {
        property_.reset();
...
std::unique_ptr<impl::IIterator> NewNonRecursiveIterator(
  ...
  switch (instance->model_type()) {
    case types::ModelType::kBranch:
      return common::make_unique<IteratorOverBranch>(
        instance
      );
    case types::ModelType::kLeaf:
      return common::make_unique<IteratorOverLeaf>(
        instance
      );
    case types::ModelType::kBlossom:
      return common::make_unique<IteratorOverBlossom>(
        instance
      );
    ...
    case types::ModelType::kContainer:
      return common::make_unique<IteratorOverContainer>(
        instance
      );
    default:
      throw std::logic_error(
