...
class OfBranch : public impl::IVerificator {
 public:
  OfBranch(
    const std::shared_ptr<types::IClass>& instance
  );
...
bool OfBranch::Done() const {
  return true;
}

const Error& OfBranch::Get() const {
  throw std::logic_error(
...
long OfBranch::Index() const {
  return -1;
}

std::unique_ptr<impl::IVerificator> OfBranch::Clone() const {
  return common::make_unique<
    OfBranch
  >(*this);
}

class OfLeaf : public impl::IVerificator {
 public:
  OfLeaf(
    const std::shared_ptr<types::IClass>& instance
  );
...
bool OfLeaf::Done() const {
  return true;
}

const Error& OfLeaf::Get() const {
  throw std::logic_error(
    "You want to get from "
    "a verificator OfLeaf, "
    "but the verificator is always done as "
...
long OfLeaf::Index() const {
  return -1;
}

std::unique_ptr<impl::IVerificator> OfLeaf::Clone() const {
  return common::make_unique<
    OfLeaf
  >(*this);
}

class OfBlossom : public impl::IVerificator {
 public:
  OfBlossom(
    const std::shared_ptr<types::IClass>& instance
  );
...
bool OfBlossom::Done() const {
  return true;
}

const Error& OfBlossom::Get() const {
  throw std::logic_error(
    "You want to get from "
    "a verificator OfBlossom, "
    "but the verificator is always done as "
...
long OfBlossom::Index() const {
  return -1;
}

std::unique_ptr<impl::IVerificator> OfBlossom::Clone() const {
  return common::make_unique<
    OfBlossom
  >(*this);
}
...
std::unique_ptr<impl::IVerificator> NewNonRecursiveVerificator(
  ...
  switch (instance->model_type()) {
    case types::ModelType::kBranch:
      return common::make_unique<
        non_recursive_verificator::OfBranch
      >(
        instance
      );
    case types::ModelType::kLeaf:
      return common::make_unique<
        non_recursive_verificator::OfLeaf
      >(
        instance
      );
    case types::ModelType::kBlossom:
      return common::make_unique<
        non_recursive_verificator::OfBlossom
      >(
        instance
      );
