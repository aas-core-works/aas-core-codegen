...
> ConcretelyDeserializeBranch(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      auto it(
        kPropertiesInBranch.find(key_val.key())
      );
      if (it == kPropertiesInBranch.end()) {
        std::wstring message = common::Concat(
  ...
  // region De-serialize identifier
  ...
  // endregion De-serialize identifier
  ...
  if (*model_type != L"Branch") {
    std::wstring message = common::Concat(
      L"Expected model type 'Branch', "
      L"but got: ",
      *model_type
    );
...
> ConcretelyDeserializeLeaf(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      auto it(
        kPropertiesInLeaf.find(key_val.key())
      );
      if (it == kPropertiesInLeaf.end()) {
        std::wstring message = common::Concat(
          L"Unexpected additional property: ",
          common::Utf8ToWstring(key_val.key())
        );
  ...
  if (*model_type != L"Leaf") {
    std::wstring message = common::Concat(
      L"Expected model type 'Leaf', "
      L"but got: ",
      *model_type
    );
...
> DeserializeBlossom(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      auto it(
        kPropertiesInBlossom.find(key_val.key())
      );
      if (it == kPropertiesInBlossom.end()) {
        std::wstring message = common::Concat(
          L"Unexpected additional property: ",
          common::Utf8ToWstring(key_val.key())
        );
  ...
  // endregion De-serialize details
  ...
  if (*model_type != L"Blossom") {
    std::wstring message = common::Concat(
      L"Expected model type 'Blossom', "
      L"but got: ",
      *model_type
    );
...
> DeserializeSomething(
  ...
  if (!json.contains("somethingWithoutChoice")) {
    return std::make_pair<
      common::optional<std::shared_ptr<types::ISomething> >,
      common::optional<DeserializationError>
    >(
  ...
  // region De-serialize someChoice
  ...
  // endregion De-serialize someChoice

  // region De-serialize somethingWithoutChoice

  std::tie(
    the_something_without_choice,
    error
  ) = DeserializeBranch(
    json["somethingWithoutChoice"],
    additional_properties
  );
  ...
  // endregion De-serialize somethingWithoutChoice
...
> DeserializeContainer(
  ...
  // endregion De-serialize node

  // region De-serialize something
  ...
  // endregion De-serialize something
...
> SerializeSomething(
  ...
  common::optional<nlohmann::json> json_some_choice;
  std::tie(
    json_some_choice,
    error
  ) = SerializeIClass(
  ...
  result["someChoice"] = std::move(
    *json_some_choice
  );

  common::optional<nlohmann::json> json_something_without_choice;
  std::tie(
    json_something_without_choice,
    error
  ) = SerializeIClass(
  ...
  result["somethingWithoutChoice"] = std::move(
    *json_something_without_choice
  );
...
> SerializeContainer(
  ...
  common::optional<nlohmann::json> json_node;
  std::tie(
    json_node,
    error
  ) = SerializeIClass(
  ...
  common::optional<nlohmann::json> json_something;
  std::tie(
    json_something,
    error
  ) = SerializeIClass(
